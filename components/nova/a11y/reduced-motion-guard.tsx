/**
 * Reduced Motion Guard - Renders the final state without motion.
 *
 ...
 * Example
 * -------
 * <ReducedMotionGuard title="Keyboard map" subtitle="Every action reachable without a mouse" live="polite" />
 */
import { Eye } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface ReducedMotionGuardProps
...
export function ReducedMotionGuard({ title = "Keyboard map", subtitle = "Every action reachable without a mouse", className, ...props }: ReducedMotionGuardProps) {
  return (
    <section
