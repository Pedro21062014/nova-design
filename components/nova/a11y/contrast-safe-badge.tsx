/**
 * Contrast Safe Badge - Badge that picks a readable foreground.
 *
 ...
 * Example
 * -------
 * <ContrastSafeBadge title="Skip to content" subtitle="Visible on focus" live="polite" />
 */
import { Eye } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface ContrastSafeBadgeProps
...
export function ContrastSafeBadge({ title = "Skip to content", subtitle = "Visible on focus", className, ...props }: ContrastSafeBadgeProps) {
  return (
    <section
...
export default ContrastSafeBadge;
