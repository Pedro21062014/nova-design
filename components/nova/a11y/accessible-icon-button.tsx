/**
 * Accessible Icon Button - Icon button with a guaranteed label.
 *
 ...
 * Example
 * -------
 * <AccessibleIconButton title="Status region" subtitle="Announced politely" live="polite" />
 */
...
export function AccessibleIconButton({ title = "Status region", subtitle = "Announced politely", className, ...props }: AccessibleIconButtonProps) {
  return (
    <section
