/**
 * Described By Hint - Wires hint and error ids to a field.
 *
 ...
 * Example
 * -------
 * <DescribedByHint title="Status region" subtitle="Announced politely" live="polite" />
 */
import { Eye } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface DescribedByHintProps
...
export function DescribedByHint({ title = "Status region", subtitle = "Announced politely", className, ...props }: DescribedByHintProps) {
  return (
    <section
...
export default DescribedByHint;
