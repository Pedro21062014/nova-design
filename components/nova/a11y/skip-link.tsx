/**
 * Skip Link - First focusable element that jumps to main.
 *
 ...
 * Example
 * -------
 * <SkipLink title="Skip to content" subtitle="Visible on focus" live="polite" />
 */
...
export function SkipLink({ title = "Skip to content", subtitle = "Visible on focus", className, ...props }: SkipLinkProps) {
  return (
    <section
