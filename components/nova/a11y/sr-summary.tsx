/**
 * Sr Summary - Screen-reader summary for dense widgets.
 *
 ...
 * Example
 * -------
 * <SrSummary title="Keyboard map" subtitle="Every action reachable without a mouse" live="polite" />
 */
import { Eye } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface SrSummaryProps
...
export function SrSummary({ title = "Keyboard map", subtitle = "Every action reachable without a mouse", className, ...props }: SrSummaryProps) {
  return (
    <section
