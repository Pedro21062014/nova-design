/**
 * Live Region - Polite or assertive announcements for async work.
 *
 ...
 * Example
 * -------
 * <LiveRegion title="Status region" subtitle="Announced politely" live="polite" />
 */
...
export function LiveRegion({ title = "Status region", subtitle = "Announced politely", className, ...props }: LiveRegionProps) {
  return (
    <section
