/**
 * Keyboard Chip - Key cap chip, desktop only.
 *
 ...
 * Example
 * -------
 * <KeyboardChip title="Currency" subtitle="Display only" value={{value}} onValueChange={{setValue}} />
 */
import { Check, Copy } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface KeyboardChipProps
...
export function KeyboardChip({ title = "Currency", subtitle = "Display only", className, ...props }: KeyboardChipProps) {
  return (
    <section
