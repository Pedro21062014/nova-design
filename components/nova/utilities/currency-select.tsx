/**
 * Currency Select - Currency picker with symbols.
 *
 ...
 * Example
 * -------
 * <CurrencySelect title="Copy link" subtitle="Copies to clipboard" value={{value}} onValueChange={{setValue}} />
 */
...
export function CurrencySelect({ title = "Copy link", subtitle = "Copies to clipboard", className, ...props }: CurrencySelectProps) {
  return (
    <section
