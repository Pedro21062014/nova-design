/**
 * Copy Button - Copy with check feedback and no toast.
 *
 ...
 * Example
 * -------
 * <CopyButton title="Copy link" subtitle="Copies to clipboard" value={{value}} onValueChange={{setValue}} />
 */
...
export function CopyButton({ title = "Copy link", subtitle = "Copies to clipboard", className, ...props }: CopyButtonProps) {
  return (
    <section
