/**
 * Number Format - Locale-aware number with compact notation.
 *
...
export function NumberFormat({ title = "Time zone", subtitle = "Stored per account", className, ...props }: NumberFormatProps) {
  return (
    <section
