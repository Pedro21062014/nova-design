/**
 * Tooltip Label - Label plus delayed tooltip.
 *
 ...
 * Example
 * -------
 * <TooltipLabel title="Time zone" subtitle="Stored per account" value={{value}} onValueChange={{setValue}} />
 */
...
export function TooltipLabel({ title = "Time zone", subtitle = "Stored per account", className, ...props }: TooltipLabelProps) {
  return (
    <section
