/**
 * Relative Time - Relative time with absolute on hover.
 *
 ...
 * Example
 * -------
 * <RelativeTime title="Copy link" subtitle="Copies to clipboard" value={{value}} onValueChange={{setValue}} />
 */
...
export function RelativeTime({ title = "Copy link", subtitle = "Copies to clipboard", className, ...props }: RelativeTimeProps) {
  return (
    <section
