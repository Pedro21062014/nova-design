/**
 * Theme Toggle - System, light and dark segmented control.
 *
 ...
 * Example
 * -------
 * <ThemeToggle title="Copy link" subtitle="Copies to clipboard" value={{value}} onValueChange={{setValue}} />
 */
...
export function ThemeToggle({ title = "Copy link", subtitle = "Copies to clipboard", className, ...props }: ThemeToggleProps) {
  return (
    <section
