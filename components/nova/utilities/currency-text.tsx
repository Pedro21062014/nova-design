/**
 * Currency Text - Currency with tabular figures.
 *
 ...
 * Example
 * -------
 * <CurrencyText title="Currency" subtitle="Display only" value={{value}} onValueChange={{setValue}} />
 */
...
export function CurrencyText({ title = "Currency", subtitle = "Display only", className, ...props }: CurrencyTextProps) {
  return (
    <section
