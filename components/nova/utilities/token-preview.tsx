/**
 * Token Preview - Shows a token name, value and swatch.
 *
 ...
 * Example
 * -------
 * <TokenPreview title="Currency" subtitle="Display only" value={{value}} onValueChange={{setValue}} />
 */
...
export function TokenPreview({ title = "Currency", subtitle = "Display only", className, ...props }: TokenPreviewProps) {
  return (
    <section
