/**
 * Truncate Text - Single-line ellipsis with title attribute.
 *
 ...
 * Example
 * -------
 * <TruncateText title="Copy link" subtitle="Copies to clipboard" value={{value}} onValueChange={{setValue}} />
 */
...
export function TruncateText({ title = "Copy link", subtitle = "Copies to clipboard", className, ...props }: TruncateTextProps) {
  return (
    <section
