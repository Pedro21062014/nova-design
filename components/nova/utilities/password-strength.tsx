/**
 * Password Strength - Strength meter with requirement list.
 *
 ...
 * Example
 * -------
 * <PasswordStrength title="Currency" subtitle="Display only" value={{value}} onValueChange={{setValue}} />
 */
...
export function PasswordStrength({ title = "Currency", subtitle = "Display only", className, ...props }: PasswordStrengthProps) {
  return (
    <section
