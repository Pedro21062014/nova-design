/**
 * Middle Truncate - Middle truncation for paths and keys.
 *
 ...
 * Example
 * -------
 * <MiddleTruncate title="Time zone" subtitle="Stored per account" value={{value}} onValueChange={{setValue}} />
 */
...
export function MiddleTruncate({ title = "Time zone", subtitle = "Stored per account", className, ...props }: MiddleTruncateProps) {
  return (
    <section
