/**
 * Qr Card - Shareable QR with a download action.
 *
 ...
 * Example
 * -------
 * <QrCard title="Copy link" subtitle="Copies to clipboard" value={{value}} onValueChange={{setValue}} />
 */
...
export function QrCard({ title = "Copy link", subtitle = "Copies to clipboard", className, ...props }: QrCardProps) {
  return (
    <section
