/**
 * Seat Card - Seat allocation with invite affordance.
 *
 ...
 * Example
 * -------
 * <SeatCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function SeatCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: SeatCardProps) {
  return (
    <section
