/**
 * Resource Card - Link card for docs, guides and videos.
 *
 ...
 * Example
 * -------
 * <ResourceCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function ResourceCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: ResourceCardProps) {
  return (
    <section
