/**
 * Pricing Card - Plan card with billing state, features and CTA.
 *
 ...
 * Example
 * -------
 * <PricingCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function PricingCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: PricingCardProps) {
  return (
    <section
