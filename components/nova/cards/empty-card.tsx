/**
 * Empty Card - Empty state card with icon, copy and one action.
 *
 ...
 * Example
 * -------
 * <EmptyCard title="Team capacity" subtitle="6 of 12 seats active" interactive />
 */
...
export function EmptyCard({ title = "Team capacity", subtitle = "6 of 12 seats active", className, ...props }: EmptyCardProps) {
  return (
    <section
