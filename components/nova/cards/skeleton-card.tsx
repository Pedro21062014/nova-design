/**
 * Skeleton Card - Skeleton that mirrors a real card shape exactly.
 *
 ...
 * Example
 * -------
 * <SkeletonCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function SkeletonCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: SkeletonCardProps) {
  return (
    <section
