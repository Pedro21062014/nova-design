/**
 * Repo Card - Repository card with stars, language and update time.
 *
 ...
 * Example
 * -------
 * <RepoCard title="Usage this month" subtitle="82 percent of the included quota" interactive />
 */
...
export function RepoCard({ title = "Usage this month", subtitle = "82 percent of the included quota", className, ...props }: RepoCardProps) {
  return (
    <section
