/**
 * Blog Card - Article card with category chip and reading time.
 *
 ...
 * Example
 * -------
 * <BlogCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function BlogCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: BlogCardProps) {
  return (
    <section
