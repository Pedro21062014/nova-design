/**
 * Action Card - Card whose whole surface is one decision.
 *
 ...
 * Example
 * -------
 * <ActionCard title="Team capacity" subtitle="6 of 12 seats active" interactive />
 */
...
export function ActionCard({ title = "Team capacity", subtitle = "6 of 12 seats active", className, ...props }: ActionCardProps) {
  return (
    <section
