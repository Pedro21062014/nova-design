/**
 * Profile Card - Person card with avatar, role, links and presence.
 *
 ...
 * Example
 * -------
 * <ProfileCard title="Usage this month" subtitle="82 percent of the included quota" interactive />
 */
...
export function ProfileCard({ title = "Usage this month", subtitle = "82 percent of the included quota", className, ...props }: ProfileCardProps) {
  return (
    <section
