/**
 * Stat Card - Metric with delta chip and comparison caption.
 *
 ...
 * Example
 * -------
 * <StatCard title="Team capacity" subtitle="6 of 12 seats active" interactive />
 */
...
export function StatCard({ title = "Team capacity", subtitle = "6 of 12 seats active", className, ...props }: StatCardProps) {
  return (
    <section
