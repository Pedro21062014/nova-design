/**
 * Interactive Card - Clickable card with lift, focus ring and pressed state.
 *
 ...
 * Example
 * -------
 * <InteractiveCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function InteractiveCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: InteractiveCardProps) {
  return (
    <section
