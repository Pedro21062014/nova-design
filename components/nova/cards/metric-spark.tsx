/**
 * Metric Spark - Metric with an inline 24-point sparkline.
 *
 ...
 * Example
 * -------
 * <MetricSpark title="Usage this month" subtitle="82 percent of the included quota" interactive />
 */
...
export function MetricSpark({ title = "Usage this month", subtitle = "82 percent of the included quota", className, ...props }: MetricSparkProps) {
  return (
    <section
