/**
 * Task Card - Task with checkbox, assignee and due date.
 *
 ...
 * Example
 * -------
 * <TaskCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function TaskCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: TaskCardProps) {
  return (
    <section
