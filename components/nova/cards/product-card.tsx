/**
 * Product Card - Product tile with price, badge and quick action.
 *
 ...
 * Example
 * -------
 * <ProductCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function ProductCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: ProductCardProps) {
  return (
    <section
