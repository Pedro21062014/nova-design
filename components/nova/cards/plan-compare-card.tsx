/**
 * Plan Compare Card - Compact plan summary for comparison grids.
 *
 ...
 * Example
 * -------
 * <PlanCompareCard title="Team capacity" subtitle="6 of 12 seats active" interactive />
 */
...
export function PlanCompareCard({ title = "Team capacity", subtitle = "6 of 12 seats active", className, ...props }: PlanCompareCardProps) {
  return (
    <section
