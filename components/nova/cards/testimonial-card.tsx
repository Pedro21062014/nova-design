/**
 * Testimonial Card - Quote, attribution and logo slot.
 *
...
export function TestimonialCard({ title = "Usage this month", subtitle = "82 percent of the included quota", className, ...props }: TestimonialCardProps) {
  return (
    <section
