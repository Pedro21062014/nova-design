/**
 * Integration Card - Integration tile with monochrome logo and status.
 *
 ...
 * Example
 * -------
 * <IntegrationCard title="Latest invoice" subtitle="Paid on the 4th" interactive />
 */
...
export function IntegrationCard({ title = "Latest invoice", subtitle = "Paid on the 4th", className, ...props }: IntegrationCardProps) {
  return (
    <section
