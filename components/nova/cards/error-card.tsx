/**
 * Error Card - Block error with retry and copyable error id.
 *
 ...
 * Example
 * -------
 * <ErrorCard title="Usage this month" subtitle="82 percent of the included quota" interactive />
 */
...
export function ErrorCard({ title = "Usage this month", subtitle = "82 percent of the included quota", className, ...props }: ErrorCardProps) {
  return (
    <section
