/**
 * Email Reset - Password reset with a short expiry warning.
 *
 ...
 * Example
 * -------
 * <EmailReset title="Your invoice is ready" subtitle="Payment received, thank you" width={{600}} />
 */
...
export function EmailReset({ title = "Your invoice is ready", subtitle = "Payment received, thank you", className, ...props }: EmailResetProps) {
  return (
    <section
