/**
 * Email Changelog - Release notes with category tags.
 *
 ...
 * Example
 * -------
 * <EmailChangelog title="Weekly digest" subtitle="Five changes worth knowing" width={{600}} />
 */
import { Mail } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface EmailChangelogProps
...
export function EmailChangelog({ title = "Weekly digest", subtitle = "Five changes worth knowing", className, ...props }: EmailChangelogProps) {
  return (
    <section
