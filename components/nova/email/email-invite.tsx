/**
 * Email Invite - Workspace invite with role and expiry.
 *
 ...
 * Example
 * -------
 * <EmailInvite title="Weekly digest" subtitle="Five changes worth knowing" width={{600}} />
 */
...
export function EmailInvite({ title = "Weekly digest", subtitle = "Five changes worth knowing", className, ...props }: EmailInviteProps) {
  return (
    <section
