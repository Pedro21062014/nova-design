/**
 * Email Quote - Testimonial block for campaign mail.
 *
 ...
 * Example
 * -------
 * <EmailQuote title="Your invoice is ready" subtitle="Payment received, thank you" width={{600}} />
 */
...
export function EmailQuote({ title = "Your invoice is ready", subtitle = "Payment received, thank you", className, ...props }: EmailQuoteProps) {
  return (
    <section
