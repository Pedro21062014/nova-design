/**
 * Email Hero - Subject, preheader and one primary action.
 *
 ...
 * Example
 * -------
 * <EmailHero title="Your invoice is ready" subtitle="Payment received, thank you" width={{600}} />
 */
...
export function EmailHero({ title = "Your invoice is ready", subtitle = "Payment received, thank you", className, ...props }: EmailHeroProps) {
  return (
    <section
