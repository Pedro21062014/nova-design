/**
 * Email Cta - Bulletproof button with a fallback link.
 *
 ...
 * Example
 * -------
 * <EmailCta title="Weekly digest" subtitle="Five changes worth knowing" width={{600}} />
 */
...
export function EmailCta({ title = "Weekly digest", subtitle = "Five changes worth knowing", className, ...props }: EmailCtaProps) {
  return (
    <section
