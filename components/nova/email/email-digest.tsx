/**
 * Email Digest - Weekly digest with five entries.
 *
 ...
 * Example
 * -------
 * <EmailDigest title="Your invoice is ready" subtitle="Payment received, thank you" width={{600}} />
 */
...
export function EmailDigest({ title = "Your invoice is ready", subtitle = "Payment received, thank you", className, ...props }: EmailDigestProps) {
  return (
    <section
