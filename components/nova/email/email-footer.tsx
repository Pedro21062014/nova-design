/**
 * Email Footer - Preference and unsubscribe links.
 *
 ...
 * Example
 * -------
 * <EmailFooter title="Welcome to Acme" subtitle="Confirm your address to get started" width={{600}} />
 */
...
export function EmailFooter({ title = "Welcome to Acme", subtitle = "Confirm your address to get started", className, ...props }: EmailFooterProps) {
  return (
    <section
