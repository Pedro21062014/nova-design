/**
 * Email Verify - Verification with a code and a link.
 *
 ...
 * Example
 * -------
 * <EmailVerify title="Welcome to Acme" subtitle="Confirm your address to get started" width={{600}} />
 */
...
export function EmailVerify({ title = "Welcome to Acme", subtitle = "Confirm your address to get started", className, ...props }: EmailVerifyProps) {
  return (
    <section
