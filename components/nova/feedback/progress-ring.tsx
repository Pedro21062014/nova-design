/**
 * Progress Ring - Ring progress with a center value.
 *
...
export function ProgressRing({ title = "Search returned no results", subtitle = "Try a shorter term", className, ...props }: ProgressRingProps) {
  return (
    <section
