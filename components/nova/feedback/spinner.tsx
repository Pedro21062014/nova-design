/**
 * Spinner - Spinner with an accessible label.
 *
 ...
 * Example
 * -------
 * <Spinner title="Nothing to show yet" subtitle="Connect a source to populate this view" tone="info" onRetry={{retry}} />
 */
...
export function Spinner({ title = "Nothing to show yet", subtitle = "Connect a source to populate this view", className, ...props }: SpinnerProps) {
  return (
    <section
