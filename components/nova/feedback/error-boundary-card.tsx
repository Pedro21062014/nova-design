/**
 * Error Boundary Card - Boundary fallback scoped to one region.
 *
 ...
 * Example
 * -------
 * <ErrorBoundaryCard title="Search returned no results" subtitle="Try a shorter term" tone="info" onRetry={{retry}} />
 */
...
export function ErrorBoundaryCard({ title = "Search returned no results", subtitle = "Try a shorter term", className, ...props }: ErrorBoundaryCardProps) {
  return (
    <section
