/**
 * Skeleton Table - Table skeleton with five rows and a header.
 *
...
export function SkeletonTable({ title = "Upload failed", subtitle = "Retry, or use a smaller file", className, ...props }: SkeletonTableProps) {
  return (
    <section
