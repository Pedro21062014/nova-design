/**
 * Skeleton Card - Card skeleton matching the real shape.
 *
 ...
 * Example
 * -------
 * <SkeletonCard title="Search returned no results" subtitle="Try a shorter term" tone="info" onRetry={{retry}} />
 */
...
export function SkeletonCard({ title = "Search returned no results", subtitle = "Try a shorter term", className, ...props }: SkeletonCardProps) {
  return (
    <section
