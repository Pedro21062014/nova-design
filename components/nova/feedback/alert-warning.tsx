/**
 * Alert Warning - Warning callout with a fix.
 *
 ...
 * Example
 * -------
 * <AlertWarning title="Nothing to show yet" subtitle="Connect a source to populate this view" tone="info" onRetry={{retry}} />
 */
...
export function AlertWarning({ title = "Nothing to show yet", subtitle = "Connect a source to populate this view", className, ...props }: AlertWarningProps) {
  return (
    <section
