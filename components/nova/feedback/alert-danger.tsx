/**
 * Alert Danger - Error callout with retry.
 *
...
export interface AlertDangerProps
...
export function AlertDanger({ title = "Search returned no results", subtitle = "Try a shorter term", className, ...props }: AlertDangerProps) {
  return (
    <section
