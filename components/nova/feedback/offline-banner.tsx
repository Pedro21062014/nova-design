/**
 * Offline Banner - Amber offline notice with queued count.
 *
 ...
 * Example
 * -------
 * <OfflineBanner title="Upload failed" subtitle="Retry, or use a smaller file" tone="info" onRetry={{retry}} />
 */
...
export function OfflineBanner({ title = "Upload failed", subtitle = "Retry, or use a smaller file", className, ...props }: OfflineBannerProps) {
  return (
    <section
