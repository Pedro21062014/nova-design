/**
 * Loading Bar - Indeterminate bar for long operations.
 *
 ...
 * Example
 * -------
 * <LoadingBar title="Upload failed" subtitle="Retry, or use a smaller file" tone="info" onRetry={{retry}} />
 */
...
export function LoadingBar({ title = "Upload failed", subtitle = "Retry, or use a smaller file", className, ...props }: LoadingBarProps) {
  return (
    <section
