/**
 * Empty Search - Zero results with removable filters.
 *
 ...
 * Example
 * -------
 * <EmptySearch title="Upload failed" subtitle="Retry, or use a smaller file" tone="info" onRetry={{retry}} />
 */
...
export function EmptySearch({ title = "Upload failed", subtitle = "Retry, or use a smaller file", className, ...props }: EmptySearchProps) {
  return (
    <section
