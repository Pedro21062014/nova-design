/**
 * Rate Limit Notice - Limit reached with a countdown and upgrade path.
 *
 ...
 * Example
 * -------
 * <RateLimitNotice title="Nothing to show yet" subtitle="Connect a source to populate this view" tone="info" onRetry={{retry}} />
 */
...
export function RateLimitNotice({ title = "Nothing to show yet", subtitle = "Connect a source to populate this view", className, ...props }: RateLimitNoticeProps) {
  return (
    <section
