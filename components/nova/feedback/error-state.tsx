/**
 * Error State - Plain-language error with retry and error id.
 *
 ...
 * Example
 * -------
 * <ErrorState title="Nothing to show yet" subtitle="Connect a source to populate this view" tone="info" onRetry={{retry}} />
 */
...
export function ErrorState({ title = "Nothing to show yet", subtitle = "Connect a source to populate this view", className, ...props }: ErrorStateProps) {
  return (
    <section
