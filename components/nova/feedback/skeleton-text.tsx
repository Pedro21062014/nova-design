/**
 * Skeleton Text - Text skeleton with three line widths.
 *
 ...
 * Example
 * -------
 * <SkeletonText title="Nothing to show yet" subtitle="Connect a source to populate this view" tone="info" onRetry={{retry}} />
 */
...
export function SkeletonText({ title = "Nothing to show yet", subtitle = "Connect a source to populate this view", className, ...props }: SkeletonTextProps) {
  return (
    <section
