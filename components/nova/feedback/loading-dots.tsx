/**
 * Loading Dots - Three dots for short waits.
 *
 ...
 * Example
 * -------
 * <LoadingDots title="Search returned no results" subtitle="Try a shorter term" tone="info" onRetry={{retry}} />
 */
...
export function LoadingDots({ title = "Search returned no results", subtitle = "Try a shorter term", className, ...props }: LoadingDotsProps) {
  return (
    <section
