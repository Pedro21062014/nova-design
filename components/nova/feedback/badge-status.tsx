/**
 * Badge Status - Status chip with tone and dot.
 *
 ...
 * Example
 * -------
 * <BadgeStatus title="Search returned no results" subtitle="Try a shorter term" tone="info" onRetry={{retry}} />
 */
...
export function BadgeStatus({ title = "Search returned no results", subtitle = "Try a shorter term", className, ...props }: BadgeStatusProps) {
  return (
    <section
