/**
 * Pulse Dot - Live indicator, one per viewport.
 *
 ...
 * Example
 * -------
 * <PulseDot title="Upload failed" subtitle="Retry, or use a smaller file" tone="info" onRetry={{retry}} />
 */
...
export function PulseDot({ title = "Upload failed", subtitle = "Retry, or use a smaller file", className, ...props }: PulseDotProps) {
  return (
    <section
