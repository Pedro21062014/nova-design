/**
 * Suggestion Grid - Empty-state prompt tiles that fill the composer.
 *
 ...
 * Example
 * -------
 * <SuggestionGrid title="Summary" subtitle="Edited 4 min ago" streaming />
 */
...
export function SuggestionGrid({ title = "Summary", subtitle = "Edited 4 min ago", className, ...props }: SuggestionGridProps) {
  return (
    <section
