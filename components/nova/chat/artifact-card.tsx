/**
 * Artifact Card - Preview strip, version chip and open canvas.
 *
 ...
 * Example
 * -------
 * <ArtifactCard title="Answer" subtitle="Model: nova-3, 1.4s" streaming />
 */
...
export function ArtifactCard({ title = "Answer", subtitle = "Model: nova-3, 1.4s", className, ...props }: ArtifactCardProps) {
  return (
    <section
