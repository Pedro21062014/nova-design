/**
 * Sources Row - Numbered source list with show-all expansion.
 *
...
export function SourcesRow({ title = "Answer", subtitle = "Model: nova-3, 1.4s", className, ...props }: SourcesRowProps) {
  return (
    <section
