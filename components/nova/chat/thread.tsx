/**
 * Thread - Message list with grouping, day separators and live region.
 *
 ...
 * Example
 * -------
 * <Thread title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function Thread({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: ThreadProps) {
  return (
    <section
