/**
 * Composer Tools - Model, tools and attachment controls.
 *
 ...
 * Example
 * -------
 * <ComposerTools title="Answer" subtitle="Model: nova-3, 1.4s" streaming />
 */
...
export function ComposerTools({ title = "Answer", subtitle = "Model: nova-3, 1.4s", className, ...props }: ComposerToolsProps) {
  return (
    <section
