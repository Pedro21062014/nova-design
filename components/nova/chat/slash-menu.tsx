/**
 * Slash Menu - Command menu anchored above the composer.
 *
 ...
 * Example
 * -------
 * <SlashMenu title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function SlashMenu({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: SlashMenuProps) {
  return (
    <section
