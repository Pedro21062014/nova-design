/**
 * Canvas Panel - Split panel with preview, code and versions.
 *
 ...
 * Example
 * -------
 * <CanvasPanel title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function CanvasPanel({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: CanvasPanelProps) {
  return (
    <section
