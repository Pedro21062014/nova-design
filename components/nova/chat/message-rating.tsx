/**
 * Message Rating - Inline feedback card with category chips.
 *
 ...
 * Example
 * -------
 * <MessageRating title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function MessageRating({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: MessageRatingProps) {
  return (
    <section
