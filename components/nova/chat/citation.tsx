/**
 * Citation - Superscript reference with a hover preview card.
 *
 ...
 * Example
 * -------
 * <Citation title="Summary" subtitle="Edited 4 min ago" streaming />
 */
...
export function Citation({ title = "Summary", subtitle = "Edited 4 min ago", className, ...props }: CitationProps) {
  return (
    <section
