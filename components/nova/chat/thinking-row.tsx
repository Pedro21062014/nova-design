/**
 * Thinking Row - Dots, shimmer label and the latency ladder.
 *
 ...
 * Example
 * -------
 * <ThinkingRow title="Answer" subtitle="Model: nova-3, 1.4s" streaming />
 */
...
export function ThinkingRow({ title = "Answer", subtitle = "Model: nova-3, 1.4s", className, ...props }: ThinkingRowProps) {
  return (
    <section
