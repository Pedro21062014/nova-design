/**
 * Model Picker - Grouped model list with context and cost hints.
 *
 ...
 * Example
 * -------
 * <ModelPicker title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function ModelPicker({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: ModelPickerProps) {
  return (
    <section
