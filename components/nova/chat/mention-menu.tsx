/**
 * Mention Menu - Mention menu for files, people and tools.
 *
 ...
 * Example
 * -------
 * <MentionMenu title="Summary" subtitle="Edited 4 min ago" streaming />
 */
...
export function MentionMenu({ title = "Summary", subtitle = "Edited 4 min ago", className, ...props }: MentionMenuProps) {
  return (
    <section
