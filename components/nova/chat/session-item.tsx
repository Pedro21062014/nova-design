/**
 * Session Item - History row with rename, pin and delete.
 *
 ...
 * Example
 * -------
 * <SessionItem title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function SessionItem({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: SessionItemProps) {
  return (
    <section
