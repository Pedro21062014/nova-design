/**
 * Attachment Grid - Image attachment grid with lightbox.
 *
 ...
 * Example
 * -------
 * <AttachmentGrid title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function AttachmentGrid({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: AttachmentGridProps) {
  return (
    <section
