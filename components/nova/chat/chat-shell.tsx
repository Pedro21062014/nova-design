/**
 * Chat Shell - Three-region layout with independent scroll containers.
 *
 ...
 * Example
 * -------
 * <ChatShell title="Answer" subtitle="Model: nova-3, 1.4s" streaming />
 */
...
export function ChatShell({ title = "Answer", subtitle = "Model: nova-3, 1.4s", className, ...props }: ChatShellProps) {
  return (
    <section
