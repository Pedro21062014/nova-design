/**
 * Typing Presence - Collaborator typing indicator and avatar stack.
 *
 ...
 * Example
 * -------
 * <TypingPresence title="Summary" subtitle="Edited 4 min ago" streaming />
 */
...
export function TypingPresence({ title = "Summary", subtitle = "Edited 4 min ago", className, ...props }: TypingPresenceProps) {
  return (
    <section
