/**
 * Context Panel - Artifacts, sources, memory and token budget.
 *
 ...
 * Example
 * -------
 * <ContextPanel title="Summary" subtitle="Edited 4 min ago" streaming />
 */
...
export function ContextPanel({ title = "Summary", subtitle = "Edited 4 min ago", className, ...props }: ContextPanelProps) {
  return (
    <section
