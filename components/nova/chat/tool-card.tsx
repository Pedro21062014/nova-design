/**
 * Tool Card - Tool call with state rule, parameters and result.
 *
 ...
 * Example
 * -------
 * <ToolCard title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function ToolCard({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: ToolCardProps) {
  return (
    <section
