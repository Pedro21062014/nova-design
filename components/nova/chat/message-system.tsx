/**
 * Message System - Centered notice chip on a hairline.
 *
 ...
 * Example
 * -------
 * <MessageSystem title="Tool call" subtitle="Search, 2 sources" streaming />
 */
...
export function MessageSystem({ title = "Tool call", subtitle = "Search, 2 sources", className, ...props }: MessageSystemProps) {
  return (
    <section
