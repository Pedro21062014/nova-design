/**
 * Message Actions - Copy, regenerate, rate, branch and share.
 *
 ...
 * Example
 * -------
 * <MessageActions title="Answer" subtitle="Model: nova-3, 1.4s" streaming />
 */
...
export function MessageActions({ title = "Answer", subtitle = "Model: nova-3, 1.4s", className, ...props }: MessageActionsProps) {
  return (
    <section
