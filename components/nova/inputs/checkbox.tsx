 ...
 * Example
 * -------
 * <Checkbox title="Workspace URL" subtitle="Lowercase, no spaces" value={{email}} onChange={{setEmail}} />
 */
...
export function Checkbox({ title = "Workspace URL", subtitle = "Lowercase, no spaces", className, ...props }: CheckboxProps) {
  return (
    <section
