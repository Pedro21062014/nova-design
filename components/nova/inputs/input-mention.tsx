/**
 * Input Mention - Mention field with grouped suggestion menu.
 *
...
export function InputMention({ title = "Workspace URL", subtitle = "Lowercase, no spaces", className, ...props }: InputMentionProps) {
  return (
    <section
