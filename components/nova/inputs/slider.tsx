/**
 * Slider - Slider with value bubble shown only while dragging.
 *
 ...
 * Example
 * -------
 * <Slider title="API key" subtitle="Rotate every 90 days" value={{email}} onChange={{setEmail}} />
 */
...
export function Slider({ title = "API key", subtitle = "Rotate every 90 days", className, ...props }: SliderProps) {
  return (
    <section
