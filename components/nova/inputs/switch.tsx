/**
 * Switch - Switch with 160ms thumb and aria role switch.
 *
 ...
 * Example
 * -------
 * <Switch title="Work email" subtitle="We never share it" value={{email}} onChange={{setEmail}} />
 */
...
export function Switch({ title = "Work email", subtitle = "We never share it", className, ...props }: SwitchProps) {
  return (
    <section
