/**
 * Combobox - Searchable select with grouped results and empty state.
 *
 ...
 * Example
 * -------
 * <Combobox title="Workspace URL" subtitle="Lowercase, no spaces" value={{email}} onChange={{setEmail}} />
 */
...
export function Combobox({ title = "Workspace URL", subtitle = "Lowercase, no spaces", className, ...props }: ComboboxProps) {
  return (
    <section
