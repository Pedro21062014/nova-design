/**
 * Date Range - Range picker with preset chips and dual month view.
 *
 ...
 * Example
 * -------
 * <DateRange title="Workspace URL" subtitle="Lowercase, no spaces" value={{email}} onChange={{setEmail}} />
 */
...
export function DateRange({ title = "Workspace URL", subtitle = "Lowercase, no spaces", className, ...props }: DateRangeProps) {
  return (
    <section
