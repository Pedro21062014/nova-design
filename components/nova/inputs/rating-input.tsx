/**
 * Rating Input - Star rating with keyboard support and hover preview.
 *
 ...
 * Example
 * -------
 * <RatingInput title="API key" subtitle="Rotate every 90 days" value={{email}} onChange={{setEmail}} />
 */
...
export function RatingInput({ title = "API key", subtitle = "Rotate every 90 days", className, ...props }: RatingInputProps) {
  return (
    <section
