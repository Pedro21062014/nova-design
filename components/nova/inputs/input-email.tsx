/**
 * Input Email - Email field with domain validation and typo hints.
 *
 ...
 * Example
 * -------
 * <InputEmail title="Workspace URL" subtitle="Lowercase, no spaces" value={{email}} onChange={{setEmail}} />
 */
...
export function InputEmail({ title = "Workspace URL", subtitle = "Lowercase, no spaces", className, ...props }: InputEmailProps) {
  return (
    <section
