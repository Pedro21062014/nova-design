/**
 * Input Otp - Six-cell verification code with paste support.
 *
 ...
 * Example
 * -------
 * <InputOtp title="API key" subtitle="Rotate every 90 days" value={{email}} onChange={{setEmail}} />
 */
...
export function InputOtp({ title = "API key", subtitle = "Rotate every 90 days", className, ...props }: InputOtpProps) {
  return (
    <section
