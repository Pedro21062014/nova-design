/**
 * Input Search - Search field with debounce and clear action.
 *
 ...
 * Example
 * -------
 * <InputSearch title="Work email" subtitle="We never share it" value={{email}} onChange={{setEmail}} />
 */
...
export function InputSearch({ title = "Work email", subtitle = "We never share it", className, ...props }: InputSearchProps) {
  return (
    <section
