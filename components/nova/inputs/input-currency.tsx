/**
 * Input Currency - Currency field with locale formatting and right alignment.
 *
 ...
 * Example
 * -------
 * <InputCurrency title="Work email" subtitle="We never share it" value={{email}} onChange={{setEmail}} />
 */
...
export function InputCurrency({ title = "Work email", subtitle = "We never share it", className, ...props }: InputCurrencyProps) {
  return (
    <section
