/**
 * Input Password - Password field with reveal toggle and strength meter.
 *
 ...
 * Example
 * -------
 * <InputPassword title="API key" subtitle="Rotate every 90 days" value={{email}} onChange={{setEmail}} />
 */
...
export function InputPassword({ title = "API key", subtitle = "Rotate every 90 days", className, ...props }: InputPasswordProps) {
  return (
    <section
