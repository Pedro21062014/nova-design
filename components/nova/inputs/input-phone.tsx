/**
 * Input Phone - Phone field that formats while typing and never blocks paste.
 *
 ...
 * Example
 * -------
 * <InputPhone title="Workspace URL" subtitle="Lowercase, no spaces" value={{email}} onChange={{setEmail}} />
 */
...
export function InputPhone({ title = "Workspace URL", subtitle = "Lowercase, no spaces", className, ...props }: InputPhoneProps) {
  return (
    <section
