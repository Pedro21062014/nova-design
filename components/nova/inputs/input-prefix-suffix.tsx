/**
 * Input Prefix Suffix - Field with locked prefix and unit suffix.
 *
 ...
 * Example
 * -------
 * <InputPrefixSuffix title="API key" subtitle="Rotate every 90 days" value={{email}} onChange={{setEmail}} />
 */
...
export function InputPrefixSuffix({ title = "API key", subtitle = "Rotate every 90 days", className, ...props }: InputPrefixSuffixProps) {
  return (
    <section
