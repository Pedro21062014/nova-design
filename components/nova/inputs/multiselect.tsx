/**
 * Multiselect - Multi-select with chips, counts and clear-all.
 *
 ...
 * Example
 * -------
 * <Multiselect title="API key" subtitle="Rotate every 90 days" value={{email}} onChange={{setEmail}} />
 */
...
export function Multiselect({ title = "API key", subtitle = "Rotate every 90 days", className, ...props }: MultiselectProps) {
  return (
    <section
