/**
 * Input Text - Text field with label, hint, error and icon slots.
 *
 ...
 * Example
 * -------
 * <InputText title="Work email" subtitle="We never share it" value={{email}} onChange={{setEmail}} />
 */
...
export function InputText({ title = "Work email", subtitle = "We never share it", className, ...props }: InputTextProps) {
  return (
    <section
