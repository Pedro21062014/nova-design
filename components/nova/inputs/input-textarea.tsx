/**
 * Input Textarea - Auto-growing textarea capped at twelve rows.
 *
 ...
 * Example
 * -------
 * <InputTextarea title="Workspace URL" subtitle="Lowercase, no spaces" value={{email}} onChange={{setEmail}} />
 */
...
export function InputTextarea({ title = "Workspace URL", subtitle = "Lowercase, no spaces", className, ...props }: InputTextareaProps) {
  return (
    <section
