/**
 * Input Tags - Tag entry with chip removal and keyboard commit.
 *
 ...
 * Example
 * -------
 * <InputTags title="Work email" subtitle="We never share it" value={{email}} onChange={{setEmail}} />
 */
...
export function InputTags({ title = "Work email", subtitle = "We never share it", className, ...props }: InputTagsProps) {
  return (
    <section
