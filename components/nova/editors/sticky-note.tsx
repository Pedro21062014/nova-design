/**
 * Sticky Note - Small note surface with colour tones.
 *
 ...
 * Example
 * -------
 * <StickyNote title="invoice.pdf" subtitle="Read only" readOnly={{false}} />
 */
...
export function StickyNote({ title = "invoice.pdf", subtitle = "Read only", className, ...props }: StickyNoteProps) {
  return (
    <section
