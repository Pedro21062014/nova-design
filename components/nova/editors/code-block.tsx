/**
 * Code Block - Code with language chip, copy and wrap toggle.
 *
 ...
 * Example
 * -------
 * <CodeBlock title="pricing.ts" subtitle="Modified 2 min ago" readOnly={{false}} />
 */
...
export function CodeBlock({ title = "pricing.ts", subtitle = "Modified 2 min ago", className, ...props }: CodeBlockProps) {
  return (
    <section
