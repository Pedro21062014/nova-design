/**
 * Rich Text Toolbar - Formatting toolbar for authoring surfaces.
 *
 ...
 * Example
 * -------
 * <RichTextToolbar title="pricing.ts" subtitle="Modified 2 min ago" readOnly={{false}} />
 */
...
export function RichTextToolbar({ title = "pricing.ts", subtitle = "Modified 2 min ago", className, ...props }: RichTextToolbarProps) {
  return (
    <section
