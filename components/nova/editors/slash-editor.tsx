/**
 * Slash Editor - Block editor with slash commands.
 *
 ...
 * Example
 * -------
 * <SlashEditor title="README.md" subtitle="Preview" readOnly={{false}} />
 */
...
export function SlashEditor({ title = "README.md", subtitle = "Preview", className, ...props }: SlashEditorProps) {
  return (
    <section
