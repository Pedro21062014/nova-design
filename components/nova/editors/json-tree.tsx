/**
 * Json Tree - Collapsible JSON with copy-path actions.
 *
 ...
 * Example
 * -------
 * <JsonTree title="README.md" subtitle="Preview" readOnly={{false}} />
 */
...
export function JsonTree({ title = "README.md", subtitle = "Preview", className, ...props }: JsonTreeProps) {
  return (
    <section
