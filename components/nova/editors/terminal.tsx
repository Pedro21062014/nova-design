/**
 * Terminal - Framed terminal with typed command option.
 *
 ...
 * Example
 * -------
 * <Terminal title="invoice.pdf" subtitle="Read only" readOnly={{false}} />
 */
...
export function Terminal({ title = "invoice.pdf", subtitle = "Read only", className, ...props }: TerminalProps) {
  return (
    <section
