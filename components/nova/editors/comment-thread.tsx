/**
 * Comment Thread - Threaded comments with resolve.
 *
 ...
 * Example
 * -------
 * <CommentThread title="pricing.ts" subtitle="Modified 2 min ago" readOnly={{false}} />
 */
...
export function CommentThread({ title = "pricing.ts", subtitle = "Modified 2 min ago", className, ...props }: CommentThreadProps) {
  return (
    <section
