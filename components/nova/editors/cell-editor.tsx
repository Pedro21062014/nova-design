/**
 * Cell Editor - Spreadsheet-style cell editing.
 *
 ...
 * Example
 * -------
 * <CellEditor title="invoice.pdf" subtitle="Read only" readOnly={{false}} />
 */
...
export function CellEditor({ title = "invoice.pdf", subtitle = "Read only", className, ...props }: CellEditorProps) {
  return (
    <section
