/**
 * Formula Input - Formula field with function hints.
 *
 ...
 * Example
 * -------
 * <FormulaInput title="pricing.ts" subtitle="Modified 2 min ago" readOnly={{false}} />
 */
...
export function FormulaInput({ title = "pricing.ts", subtitle = "Modified 2 min ago", className, ...props }: FormulaInputProps) {
  return (
    <section
