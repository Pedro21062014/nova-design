/**
 * Diff Viewer - Unified diff with hunk collapse.
 *
 ...
 * Example
 * -------
 * <DiffViewer title="pricing.ts" subtitle="Modified 2 min ago" readOnly={{false}} />
 */
...
export function DiffViewer({ title = "pricing.ts", subtitle = "Modified 2 min ago", className, ...props }: DiffViewerProps) {
  return (
    <section
