/**
 * Persona Card - System persona with tone and constraints.
 *
 ...
 * Example
 * -------
 * <PersonaCard title="Generated draft" subtitle="Grounded on 3 sources" streaming={{false}} />
 */
...
export function PersonaCard({ title = "Generated draft", subtitle = "Grounded on 3 sources", className, ...props }: PersonaCardProps) {
  return (
    <section
