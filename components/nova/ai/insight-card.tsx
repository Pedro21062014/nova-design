/**
 * Insight Card - Generated insight with confidence and sources.
 *
 ...
 * Example
 * -------
 * <InsightCard title="Generated draft" subtitle="Grounded on 3 sources" streaming={{false}} />
 */
...
export function InsightCard({ title = "Generated draft", subtitle = "Grounded on 3 sources", className, ...props }: InsightCardProps) {
  return (
    <section
