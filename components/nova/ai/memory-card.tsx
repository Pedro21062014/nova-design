/**
 * Memory Card - Long-term memory entries the agent can use.
 *
 ...
 * Example
 * -------
 * <MemoryCard title="Generated draft" subtitle="Grounded on 3 sources" streaming={{false}} />
 */
...
export function MemoryCard({ title = "Generated draft", subtitle = "Grounded on 3 sources", className, ...props }: MemoryCardProps) {
  return (
    <section
