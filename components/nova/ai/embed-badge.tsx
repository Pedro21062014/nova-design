/**
 * Embed Badge - Embedding model badge with dimension.
 *
 ...
 * Example
 * -------
 * <EmbedBadge title="Model settings" subtitle="nova-3, temperature 0.2" streaming={{false}} />
 */
...
export function EmbedBadge({ title = "Model settings", subtitle = "nova-3, temperature 0.2", className, ...props }: EmbedBadgeProps) {
  return (
    <section
