/**
 * Dataset Card - Dataset summary with row count and schema.
 *
 ...
 * Example
 * -------
 * <DatasetCard title="Generated draft" subtitle="Grounded on 3 sources" streaming={{false}} />
 */
...
export function DatasetCard({ title = "Generated draft", subtitle = "Grounded on 3 sources", className, ...props }: DatasetCardProps) {
  return (
    <section
