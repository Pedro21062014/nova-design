/**
 * Prompt Library - Saved prompts with tags and insert action.
 *
 ...
 * Example
 * -------
 * <PromptLibrary title="Reasoning" subtitle="4 steps, 900ms" streaming={{false}} />
 */
...
export function PromptLibrary({ title = "Reasoning", subtitle = "4 steps, 900ms", className, ...props }: PromptLibraryProps) {
  return (
    <section
