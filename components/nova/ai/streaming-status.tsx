/**
 * Streaming Status - Connection health for a live stream.
 *
 ...
 * Example
 * -------
 * <StreamingStatus title="Reasoning" subtitle="4 steps, 900ms" streaming={{false}} />
 */
...
export function StreamingStatus({ title = "Reasoning", subtitle = "4 steps, 900ms", className, ...props }: StreamingStatusProps) {
  return (
    <section
