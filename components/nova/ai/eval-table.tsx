/**
 * Eval Table - Evaluation results with pass rates.
 *
 ...
 * Example
 * -------
 * <EvalTable title="Reasoning" subtitle="4 steps, 900ms" streaming={{false}} />
 */
...
export function EvalTable({ title = "Reasoning", subtitle = "4 steps, 900ms", className, ...props }: EvalTableProps) {
  return (
    <section
