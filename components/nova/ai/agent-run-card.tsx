/**
 * Agent Run Card - A single agent run with outcome and cost.
 *
 ...
 * Example
 * -------
 * <AgentRunCard title="Generated draft" subtitle="Grounded on 3 sources" streaming={{false}} />
 */
...
export function AgentRunCard({ title = "Generated draft", subtitle = "Grounded on 3 sources", className, ...props }: AgentRunCardProps) {
  return (
    <section
