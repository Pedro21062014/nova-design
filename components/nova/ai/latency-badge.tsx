/**
 * Latency Badge - Latency and throughput indicator.
 *
 ...
 * Example
 * -------
 * <LatencyBadge title="Model settings" subtitle="nova-3, temperature 0.2" streaming={{false}} />
 */
...
export function LatencyBadge({ title = "Model settings", subtitle = "nova-3, temperature 0.2", className, ...props }: LatencyBadgeProps) {
  return (
    <section
