/**
 * Tool Toggle List - Enable or disable agent tools.
 *
 ...
 * Example
 * -------
 * <ToolToggleList title="Model settings" subtitle="nova-3, temperature 0.2" streaming={{false}} />
 */
import { ChevronDown, Sparkles } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface ToolToggleListProps
...
export function ToolToggleList({ title = "Model settings", subtitle = "nova-3, temperature 0.2", className, ...props }: ToolToggleListProps) {
  return (
    <section
