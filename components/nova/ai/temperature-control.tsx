/**
 * Temperature Control - Creativity control with three labelled stops.
 *
 ...
 * Example
 * -------
 * <TemperatureControl title="Generated draft" subtitle="Grounded on 3 sources" streaming={{false}} />
 */
...
export function TemperatureControl({ title = "Generated draft", subtitle = "Grounded on 3 sources", className, ...props }: TemperatureControlProps) {
  return (
    <section
