/**
 * Rag Source List - Retrieved chunks with scores.
 *
 ...
 * Example
 * -------
 * <RagSourceList title="Reasoning" subtitle="4 steps, 900ms" streaming={{false}} />
 */
import { ChevronDown, Sparkles } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface RagSourceListProps
...
export function RagSourceList({ title = "Reasoning", subtitle = "4 steps, 900ms", className, ...props }: RagSourceListProps) {
  return (
    <section
