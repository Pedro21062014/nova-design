/**
 * Guardrail Panel - Policy rules with severity and action.
 *
 ...
 * Example
 * -------
 * <GuardrailPanel title="Model settings" subtitle="nova-3, temperature 0.2" streaming={{false}} />
 */
...
export function GuardrailPanel({ title = "Model settings", subtitle = "nova-3, temperature 0.2", className, ...props }: GuardrailPanelProps) {
  return (
    <section
