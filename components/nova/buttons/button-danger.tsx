/**
 * Button Danger - Tinted destructive action, solid only in confirm dialogs.
 *
 ...
 * Example
 * -------
 * <ButtonDanger iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Invite teammate
</ButtonDanger>
 */
...
export function ButtonDanger({ title = "Invite teammate", subtitle = "Sends one email", className, ...props }: ButtonDangerProps) {
  return (
    <section
