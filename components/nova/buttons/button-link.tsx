/**
 * Button Link - Inline link styled as an action with underline offset.
 *
 ...
 * Example
 * -------
 * <ButtonLink iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Run pipeline
</ButtonLink>
 */
...
export function ButtonLink({ title = "Run pipeline", subtitle = "Queues a job now", className, ...props }: ButtonLinkProps) {
  return (
    <section
