/**
 * Button Split - Split action with a menu on the trailing segment.
 *
 ...
 * Example
 * -------
 * <ButtonSplit iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Invite teammate
</ButtonSplit>
 */
...
export function ButtonSplit({ title = "Invite teammate", subtitle = "Sends one email", className, ...props }: ButtonSplitProps) {
  return (
    <section
