/**
 * Button Submit Bar - Sticky submit bar with dirty-state enabling.
 *
 ...
 * Example
 * -------
 * <ButtonSubmitBar iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Export CSV
</ButtonSubmitBar>
 */
...
export interface ButtonSubmitBarProps
...
export function ButtonSubmitBar({ title = "Export CSV", subtitle = "Downloads the current view", className, ...props }: ButtonSubmitBarProps) {
  return (
    <section
...
export default ButtonSubmitBar;
