/**
 * Button Async - Async action with promise states and retry on failure.
 *
 ...
 * Example
 * -------
 * <ButtonAsync iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Invite teammate
</ButtonAsync>
 */
...
export interface ButtonAsyncProps
...
export function ButtonAsync({ title = "Invite teammate", subtitle = "Sends one email", className, ...props }: ButtonAsyncProps) {
  return (
    <section
