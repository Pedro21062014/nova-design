/**
 * Button Ghost - Transparent until hover, for dense toolbars.
 *
 ...
 * Example
 * -------
 * <ButtonGhost iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Run pipeline
</ButtonGhost>
 */
...
export function ButtonGhost({ title = "Run pipeline", subtitle = "Queues a job now", className, ...props }: ButtonGhostProps) {
  return (
    <section
