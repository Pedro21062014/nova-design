/**
 * Button Copy - Copy action with check feedback, no toast.
 *
 ...
 * Example
 * -------
 * <ButtonCopy iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Run pipeline
</ButtonCopy>
 */
...
export function ButtonCopy({ title = "Run pipeline", subtitle = "Queues a job now", className, ...props }: ButtonCopyProps) {
  return (
    <section
