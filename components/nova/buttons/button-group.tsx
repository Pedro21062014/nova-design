/**
 * Button Group - Segmented group sharing one glass shell.
 *
 ...
 * Example
 * -------
 * <ButtonGroup iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Invite teammate
</ButtonGroup>
 */
...
export function ButtonGroup({ title = "Invite teammate", subtitle = "Sends one email", className, ...props }: ButtonGroupProps) {
  return (
    <section
