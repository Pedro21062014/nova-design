/**
 * Button Pill - Pill action for chips rows and mobile filters.
 *
 ...
 * Example
 * -------
 * <ButtonPill iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Invite teammate
</ButtonPill>
 */
...
export function ButtonPill({ title = "Invite teammate", subtitle = "Sends one email", className, ...props }: ButtonPillProps) {
  return (
    <section
