/**
 * Button Outline - Hairline outline that becomes accent on hover.
 *
 ...
 * Example
 * -------
 * <ButtonOutline iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Export CSV
</ButtonOutline>
 */
...
export function ButtonOutline({ title = "Export CSV", subtitle = "Downloads the current view", className, ...props }: ButtonOutlineProps) {
  return (
    <section
