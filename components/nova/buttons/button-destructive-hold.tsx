/**
 * Button Destructive Hold - Hold-to-confirm for irreversible actions.
 *
 ...
 * Example
 * -------
 * <ButtonDestructiveHold iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Run pipeline
...
export interface ButtonDestructiveHoldProps
...
export function ButtonDestructiveHold({ title = "Run pipeline", subtitle = "Queues a job now", className, ...props }: ButtonDestructiveHoldProps) {
  return (
    <section
    ...
    >
      <header className="flex items-baseline justify-between gap-4">
        ...
        <span className="inline-flex shrink-0 items-center gap-1.5 font-[var(--font-mono)] text-[11px] text-[var(--fg-subtle)]">
          ...
          buttons/button-destructive-hold
        </span>
      </header>
...
export default ButtonDestructiveHold;
