/**
 * Button Toggle - Pressed state button for filters and toolbars.
 *
 ...
 * Example
 * -------
 * <ButtonToggle iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Export CSV
</ButtonToggle>
 */
...
export function ButtonToggle({ title = "Export CSV", subtitle = "Downloads the current view", className, ...props }: ButtonToggleProps) {
  return (
    <section
