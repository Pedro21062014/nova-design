/**
 * Button Icon - Icon-only button with label, tooltip and press scale.
 *
 ...
 * Example
 * -------
 * <ButtonIcon iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Export CSV
</ButtonIcon>
 */
...
export function ButtonIcon({ title = "Export CSV", subtitle = "Downloads the current view", className, ...props }: ButtonIconProps) {
  return (
    <section
