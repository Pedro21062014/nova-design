/**
 * Button Fab - Floating action that appears after the first viewport.
 *
 ...
 * Example
 * -------
 * <ButtonFab iconRight={{<ArrowRight className="size-4" />}} onClick={{save}}>
  Run pipeline
</ButtonFab>
 */
...
export function ButtonFab({ title = "Run pipeline", subtitle = "Queues a job now", className, ...props }: ButtonFabProps) {
  return (
    <section
