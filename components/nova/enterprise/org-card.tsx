/**
 * Org Card - Organization identity and plan.
 *
 ...
 * Example
 * -------
 * <OrgCard title="Access review" subtitle="Owner: Platform, due in 6 days" restricted={{false}} />
 */
...
export function OrgCard({ title = "Access review", subtitle = "Owner: Platform, due in 6 days", className, ...props }: OrgCardProps) {
  return (
    <section
