/**
 * Permission Chip - Single permission with a scope tooltip.
 *
 ...
 * Example
 * -------
 * <PermissionChip title="Access review" subtitle="Owner: Platform, due in 6 days" restricted={{false}} />
 */
...
export function PermissionChip({ title = "Access review", subtitle = "Owner: Platform, due in 6 days", className, ...props }: PermissionChipProps) {
  return (
    <section
