/**
 * Compliance Badge - SOC 2, GDPR or HIPAA badge.
 *
 ...
 * Example
 * -------
 * <ComplianceBadge title="Approval policy" subtitle="Two approvers above 10k" restricted={{false}} />
 */
...
export function ComplianceBadge({ title = "Approval policy", subtitle = "Two approvers above 10k", className, ...props }: ComplianceBadgeProps) {
  return (
    <section
