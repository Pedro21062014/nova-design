/**
 * Sales Contact - Named contact with response time.
 *
 ...
 * Example
 * -------
 * <SalesContact title="Access review" subtitle="Owner: Platform, due in 6 days" restricted={{false}} />
 */
import { Settings, Users } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface SalesContactProps
...
export function SalesContact({ title = "Access review", subtitle = "Owner: Platform, due in 6 days", className, ...props }: SalesContactProps) {
  return (
    <section
