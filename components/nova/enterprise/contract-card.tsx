/**
 * Contract Card - Term, renewal and signed documents.
 *
 ...
 * Example
 * -------
 * <ContractCard title="Access review" subtitle="Owner: Platform, due in 6 days" restricted={{false}} />
 */
...
export function ContractCard({ title = "Access review", subtitle = "Owner: Platform, due in 6 days", className, ...props }: ContractCardProps) {
  return (
    <section
