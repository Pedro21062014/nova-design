/**
 * Role Card - Role with member count and description.
 *
 ...
 * Example
 * -------
 * <RoleCard title="Data residency" subtitle="EU only, pinned" restricted={{false}} />
 */
...
export function RoleCard({ title = "Data residency", subtitle = "EU only, pinned", className, ...props }: RoleCardProps) {
  return (
    <section
