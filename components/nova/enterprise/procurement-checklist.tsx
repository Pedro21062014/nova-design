/**
 * Procurement Checklist - Vendor onboarding steps.
 *
 ...
 * Example
 * -------
 * <ProcurementChecklist title="Data residency" subtitle="EU only, pinned" restricted={{false}} />
 */
import { Settings, Users } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface ProcurementChecklistProps
...
export function ProcurementChecklist({ title = "Data residency", subtitle = "EU only, pinned", className, ...props }: ProcurementChecklistProps) {
  return (
    <section
