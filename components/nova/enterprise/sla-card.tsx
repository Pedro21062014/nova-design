/**
 * Sla Card - Uptime commitment and credits.
 *
 ...
 * Example
 * -------
 * <SlaCard title="Data residency" subtitle="EU only, pinned" restricted={{false}} />
 */
...
export function SlaCard({ title = "Data residency", subtitle = "EU only, pinned", className, ...props }: SlaCardProps) {
  return (
    <section
