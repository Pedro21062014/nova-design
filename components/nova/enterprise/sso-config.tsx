/**
 * Sso Config - SAML or OIDC setup with test connection.
 *
 ...
 * Example
 * -------
 * <SsoConfig title="Access review" subtitle="Owner: Platform, due in 6 days" restricted={{false}} />
 */
...
export function SsoConfig({ title = "Access review", subtitle = "Owner: Platform, due in 6 days", className, ...props }: SsoConfigProps) {
  return (
    <section
