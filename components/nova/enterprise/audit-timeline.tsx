/**
 * Audit Timeline - Immutable action history.
 *
 ...
 * Example
 * -------
 * <AuditTimeline title="Data residency" subtitle="EU only, pinned" restricted={{false}} />
 */
...
export function AuditTimeline({ title = "Data residency", subtitle = "EU only, pinned", className, ...props }: AuditTimelineProps) {
  return (
    <section
