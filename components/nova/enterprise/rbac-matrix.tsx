/**
 * Rbac Matrix - Role and permission grid.
 *
 ...
 * Example
 * -------
 * <RbacMatrix title="Approval policy" subtitle="Two approvers above 10k" restricted={{false}} />
 */
...
export function RbacMatrix({ title = "Approval policy", subtitle = "Two approvers above 10k", className, ...props }: RbacMatrixProps) {
  return (
    <section
