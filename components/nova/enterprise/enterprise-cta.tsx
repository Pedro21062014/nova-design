/**
 * Enterprise Cta - Talk to sales with real assurances.
 *
 ...
 * Example
 * -------
 * <EnterpriseCta title="Approval policy" subtitle="Two approvers above 10k" restricted={{false}} />
 */
...
export function EnterpriseCta({ title = "Approval policy", subtitle = "Two approvers above 10k", className, ...props }: EnterpriseCtaProps) {
  return (
    <section
