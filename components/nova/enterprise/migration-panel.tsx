/**
 * Migration Panel - Import from a competitor with mapping.
 *
 ...
 * Example
 * -------
 * <MigrationPanel title="Approval policy" subtitle="Two approvers above 10k" restricted={{false}} />
 */
...
export function MigrationPanel({ title = "Approval policy", subtitle = "Two approvers above 10k", className, ...props }: MigrationPanelProps) {
  return (
    <section
