/**
 * Security Review Card - Questionnaire progress for procurement.
 *
 ...
 * Example
 * -------
 * <SecurityReviewCard title="Approval policy" subtitle="Two approvers above 10k" restricted={{false}} />
 */
import { Quote } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface SecurityReviewCardProps
...
export function SecurityReviewCard({ title = "Approval policy", subtitle = "Two approvers above 10k", className, ...props }: SecurityReviewCardProps) {
  return (
    <section
    ...
    >
      <header className="flex items-baseline justify-between gap-4">
        ...
        <span className="inline-flex shrink-0 items-center gap-1.5 font-[var(--font-mono)] text-[11px] text-[var(--fg-subtle)]">
          ...
          enterprise/security-review-card
        </span>
      </header>
...
export default SecurityReviewCard;
