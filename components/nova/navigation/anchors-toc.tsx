/**
 * Anchors Toc - On-this-page rail with active marker.
 *
 ...
 * Example
 * -------
 * <AnchorsToc title="Overview" subtitle="This month" current="/anchors-toc" />
 */
import { Search } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface AnchorsTocProps
...
export function AnchorsToc({ title = "Overview", subtitle = "This month", className, ...props }: AnchorsTocProps) {
  return (
    <section
