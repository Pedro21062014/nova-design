/**
 * Footer Oversized - Footer with an oversized clipped wordmark.
 *
 ...
 * Example
 * -------
 * <FooterOversized title="Acme" subtitle="Workspace" current="/footer-oversized" />
 */
import { Search } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface FooterOversizedProps
...
export function FooterOversized({ title = "Acme", subtitle = "Workspace", className, ...props }: FooterOversizedProps) {
  return (
    <section
...
export default FooterOversized;
