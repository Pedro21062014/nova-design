/**
 * Breadcrumbs - Breadcrumbs that collapse beyond four levels.
 *
 ...
 * Example
 * -------
 * <Breadcrumbs title="Billing" subtitle="Settings" current="/breadcrumbs" />
 */
...
export function Breadcrumbs({ title = "Billing", subtitle = "Settings", className, ...props }: BreadcrumbsProps) {
  return (
    <section
