/**
 * Sidebar - App sidebar with sections and persisted collapse.
 *
 ...
 * Example
 * -------
 * <Sidebar title="Billing" subtitle="Settings" current="/sidebar" />
 */
...
export function Sidebar({ title = "Billing", subtitle = "Settings", className, ...props }: SidebarProps) {
  return (
    <section
