/**
 * Dock - Floating glass dock for primary app actions.
 *
 ...
 * Example
 * -------
 * <Dock title="Acme" subtitle="Workspace" current="/dock" />
 */
...
export function Dock({ title = "Acme", subtitle = "Workspace", className, ...props }: DockProps) {
  return (
    <section
