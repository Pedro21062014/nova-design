/**
 * Command Palette - Cmd K palette with scopes, recents and shortcut hints.
 *
 ...
 * Example
 * -------
 * <CommandPalette title="Overview" subtitle="This month" current="/command-palette" />
 */
...
export function CommandPalette({ title = "Overview", subtitle = "This month", className, ...props }: CommandPaletteProps) {
  return (
    <section
