/**
 * Mega Menu - Grouped menu with columns and a visual slot.
 *
 ...
 * Example
 * -------
 * <MegaMenu title="Overview" subtitle="This month" current="/mega-menu" />
 */
...
export function MegaMenu({ title = "Overview", subtitle = "This month", className, ...props }: MegaMenuProps) {
  return (
    <section
