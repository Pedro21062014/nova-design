/**
 * User Menu - Account menu with theme control and sign out.
 *
 ...
 * Example
 * -------
 * <UserMenu title="Billing" subtitle="Settings" current="/user-menu" />
 */
...
export function UserMenu({ title = "Billing", subtitle = "Settings", className, ...props }: UserMenuProps) {
  return (
    <section
