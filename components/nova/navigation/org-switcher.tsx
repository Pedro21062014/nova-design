/**
 * Org Switcher - Workspace switcher with search and creation.
 *
 ...
 * Example
 * -------
 * <OrgSwitcher title="Overview" subtitle="This month" current="/org-switcher" />
 */
...
export function OrgSwitcher({ title = "Overview", subtitle = "This month", className, ...props }: OrgSwitcherProps) {
  return (
    <section
