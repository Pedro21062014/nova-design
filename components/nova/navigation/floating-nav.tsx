/**
 * Floating Nav - Compact nav that appears on scroll up.
 *
 ...
 * Example
 * -------
 * <FloatingNav title="Billing" subtitle="Settings" current="/floating-nav" />
 */
...
export function FloatingNav({ title = "Billing", subtitle = "Settings", className, ...props }: FloatingNavProps) {
  return (
    <section
