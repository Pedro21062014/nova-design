/**
 * Pagination - Pagination with window compression and page size.
 *
 ...
 * Example
 * -------
 * <Pagination title="Overview" subtitle="This month" current="/pagination" />
 */
...
export function Pagination({ title = "Overview", subtitle = "This month", className, ...props }: PaginationProps) {
  return (
    <section
