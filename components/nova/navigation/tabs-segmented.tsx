/**
 * Tabs Segmented - Segmented control for view switching.
 *
 ...
 * Example
 * -------
 * <TabsSegmented title="Billing" subtitle="Settings" current="/tabs-segmented" />
 */
...
export function TabsSegmented({ title = "Billing", subtitle = "Settings", className, ...props }: TabsSegmentedProps) {
  return (
    <section
