/**
 * Tabs Underline - Underline tabs for content sections.
 *
 ...
 * Example
 * -------
 * <TabsUnderline title="Acme" subtitle="Workspace" current="/tabs-underline" />
 */
...
export function TabsUnderline({ title = "Acme", subtitle = "Workspace", className, ...props }: TabsUnderlineProps) {
  return (
    <section
