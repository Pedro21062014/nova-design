/**
 * Navbar Links - Nav links with sliding accent underline and scroll spy.
 *
 ...
 * Example
 * -------
 * <NavbarLinks title="Billing" subtitle="Settings" current="/navbar-links" />
 */
...
export function NavbarLinks({ title = "Billing", subtitle = "Settings", className, ...props }: NavbarLinksProps) {
  return (
    <section
