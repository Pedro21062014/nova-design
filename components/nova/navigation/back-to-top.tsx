/**
 * Back to Top - Appears after 1.5 viewports with smooth scroll.
 *
 ...
 * Example
 * -------
 * <BackToTop title="Acme" subtitle="Workspace" current="/back-to-top" />
 */
...
export function BackToTop({ title = "Acme", subtitle = "Workspace", className, ...props }: BackToTopProps) {
  return (
    <section
