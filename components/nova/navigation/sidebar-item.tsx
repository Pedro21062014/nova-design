/**
 * Sidebar Item - Nav item with active bar, badge and focus states.
 *
 ...
 * Example
 * -------
 * <SidebarItem title="Acme" subtitle="Workspace" current="/sidebar-item" />
 */
...
export function SidebarItem({ title = "Acme", subtitle = "Workspace", className, ...props }: SidebarItemProps) {
  return (
    <section
