/**
 * Sidebar Rail - Icon rail with delayed tooltips.
 *
 ...
 * Example
 * -------
 * <SidebarRail title="Overview" subtitle="This month" current="/sidebar-rail" />
 */
...
export function SidebarRail({ title = "Overview", subtitle = "This month", className, ...props }: SidebarRailProps) {
  return (
    <section
