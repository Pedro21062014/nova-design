/**
 * Tabs - Tabs with keyboard navigation and lazy panels.
 *
 ...
 * Example
 * -------
 * <Tabs title="Overview" subtitle="This month" current="/tabs" />
 */
...
export function Tabs({ title = "Overview", subtitle = "This month", className, ...props }: TabsProps) {
  return (
    <section
