/**
 * Scroll Spy Nav - Sections tracked by IntersectionObserver.
 *
 ...
 * Example
 * -------
 * <ScrollSpyNav title="Billing" subtitle="Settings" current="/scroll-spy-nav" />
 */
...
export function ScrollSpyNav({ title = "Billing", subtitle = "Settings", className, ...props }: ScrollSpyNavProps) {
  return (
    <section
