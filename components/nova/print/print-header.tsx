/**
 * Print Header - Document header with logo and reference.
 *
 ...
 * Example
 * -------
 * <PrintHeader title="Statement of work" subtitle="Revision 3, 2026-09-15" pageSize="A4" />
 */
...
export function PrintHeader({ title = "Statement of work", subtitle = "Revision 3, 2026-09-15", className, ...props }: PrintHeaderProps) {
  return (
    <section
