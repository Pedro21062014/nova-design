/**
 * Print Cover - Cover page with title and metadata.
 *
 ...
 * Example
 * -------
 * <PrintCover title="Statement of work" subtitle="Revision 3, 2026-09-15" pageSize="A4" />
 */
...
export function PrintCover({ title = "Statement of work", subtitle = "Revision 3, 2026-09-15", className, ...props }: PrintCoverProps) {
  return (
    <section
