/**
 * Print Chart - Chart with a caption that survives grayscale.
 *
 ...
 * Example
 * -------
 * <PrintChart title="Handover checklist" subtitle="Project Meridian" pageSize="A4" />
 */
...
export function PrintChart({ title = "Handover checklist", subtitle = "Project Meridian", className, ...props }: PrintChartProps) {
  return (
    <section
