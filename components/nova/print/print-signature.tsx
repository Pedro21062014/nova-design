/**
 * Print Signature - Signature block with date line.
 *
...
export function PrintSignature({ title = "Statement of work", subtitle = "Revision 3, 2026-09-15", className, ...props }: PrintSignatureProps) {
  return (
    <section
