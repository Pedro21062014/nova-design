/**
 * Print Footer - Page number and confidentiality note.
 *
 ...
 * Example
 * -------
 * <PrintFooter title="Usage report" subtitle="Billing period August 2026" pageSize="A4" />
 */
...
export function PrintFooter({ title = "Usage report", subtitle = "Billing period August 2026", className, ...props }: PrintFooterProps) {
  return (
    <section
