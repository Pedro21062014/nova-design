/**
 * Print Report - Report cover with period and author.
 *
 ...
 * Example
 * -------
 * <PrintReport title="Handover checklist" subtitle="Project Meridian" pageSize="A4" />
 */
...
export function PrintReport({ title = "Handover checklist", subtitle = "Project Meridian", className, ...props }: PrintReportProps) {
  return (
    <section
