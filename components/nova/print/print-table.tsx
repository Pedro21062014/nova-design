/**
 * Print Table - Table that repeats its header across pages.
 *
...
export function PrintTable({ title = "Usage report", subtitle = "Billing period August 2026", className, ...props }: PrintTableProps) {
  return (
    <section
