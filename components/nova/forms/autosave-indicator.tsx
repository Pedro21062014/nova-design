/**
 * Autosave Indicator - Saved state without layout shift.
 *
 ...
 * Example
 * -------
 * <AutosaveIndicator title="Report an issue" subtitle="We reply within one business day" onSubmit={{submit}} />
 */
...
export function AutosaveIndicator({ title = "Report an issue", subtitle = "We reply within one business day", className, ...props }: AutosaveIndicatorProps) {
  return (
    <section
