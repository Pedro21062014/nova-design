/**
 * Conditional Fields - Fields revealed by a previous answer.
 *
 ...
 * Example
 * -------
 * <ConditionalFields title="Shipping details" subtitle="Delivered in 3 days" onSubmit={{submit}} />
 */
...
export function ConditionalFields({ title = "Shipping details", subtitle = "Delivered in 3 days", className, ...props }: ConditionalFieldsProps) {
  return (
    <section
