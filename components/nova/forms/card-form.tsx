/**
 * Card Form - Payment details with formatting masks.
 *
 ...
 * Example
 * -------
 * <CardForm title="Report an issue" subtitle="We reply within one business day" onSubmit={{submit}} />
 */
...
export function CardForm({ title = "Report an issue", subtitle = "We reply within one business day", className, ...props }: CardFormProps) {
  return (
    <section
