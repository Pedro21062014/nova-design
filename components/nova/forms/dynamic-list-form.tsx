/**
 * Dynamic List Form - Repeatable rows with add and remove.
 *
 ...
 * Example
 * -------
 * <DynamicListForm title="Shipping details" subtitle="Delivered in 3 days" onSubmit={{submit}} />
 */
import { Mail } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface DynamicListFormProps
...
export function DynamicListForm({ title = "Shipping details", subtitle = "Delivered in 3 days", className, ...props }: DynamicListFormProps) {
  return (
    <section
