/**
 * Form Section - Grouped fields with a section heading.
 *
 ...
 * Example
 * -------
 * <FormSection title="Shipping details" subtitle="Delivered in 3 days" onSubmit={{submit}} />
 */
...
export function FormSection({ title = "Shipping details", subtitle = "Delivered in 3 days", className, ...props }: FormSectionProps) {
  return (
    <section
