/**
 * Unsaved Guard - Blocks navigation when the form is dirty.
 *
 ...
 * Example
 * -------
 * <UnsavedGuard title="Report an issue" subtitle="We reply within one business day" onSubmit={{submit}} />
 */
...
export function UnsavedGuard({ title = "Report an issue", subtitle = "We reply within one business day", className, ...props }: UnsavedGuardProps) {
  return (
    <section
