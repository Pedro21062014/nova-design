/**
 * Submit Bar - Sticky bar with dirty enabling and cancel.
 *
 ...
 * Example
 * -------
 * <SubmitBar title="Create an account" subtitle="No credit card required" onSubmit={{submit}} />
 */
...
export function SubmitBar({ title = "Create an account", subtitle = "No credit card required", className, ...props }: SubmitBarProps) {
  return (
    <section
