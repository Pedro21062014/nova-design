/**
 * Signature Pad - Canvas signature with clear and undo.
 *
 ...
 * Example
 * -------
 * <SignaturePad title="Shipping details" subtitle="Delivered in 3 days" onSubmit={{submit}} />
 */
...
export function SignaturePad({ title = "Shipping details", subtitle = "Delivered in 3 days", className, ...props }: SignaturePadProps) {
  return (
    <section
