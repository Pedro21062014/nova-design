/**
 * Credit Card Input - Card number, expiry and CVC in one row.
 *
 ...
 * Example
 * -------
 * <CreditCardInput title="Create an account" subtitle="No credit card required" onSubmit={{submit}} />
 */
...
export function CreditCardInput({ title = "Create an account", subtitle = "No credit card required", className, ...props }: CreditCardInputProps) {
  return (
    <section
