/**
 * Field Group - Label, hint and error wiring wrapper.
 *
 ...
 * Example
 * -------
 * <FieldGroup title="Create an account" subtitle="No credit card required" onSubmit={{submit}} />
 */
...
export function FieldGroup({ title = "Create an account", subtitle = "No credit card required", className, ...props }: FieldGroupProps) {
  return (
    <section
