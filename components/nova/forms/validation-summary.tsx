/**
 * Validation Summary - Top-of-form summary after a failed submit.
 *
 ...
 * Example
 * -------
 * <ValidationSummary title="Report an issue" subtitle="We reply within one business day" onSubmit={{submit}} />
 */
...
export function ValidationSummary({ title = "Report an issue", subtitle = "We reply within one business day", className, ...props }: ValidationSummaryProps) {
  return (
    <section
