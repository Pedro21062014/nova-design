/**
 * Reading Progress - Scroll progress for long articles.
 *
 ...
 * Example
 * -------
 * <ReadingProgress title="Changelog" subtitle="Every release since 1.0, written for humans" structured={{true}} />
 */
...
export function ReadingProgress({ title = "Changelog", subtitle = "Every release since 1.0, written for humans", className, ...props }: ReadingProgressProps) {
  return (
    <section
