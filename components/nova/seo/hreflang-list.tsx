/**
 * Hreflang List - Locale alternates with validation.
 *
 ...
 * Example
 * -------
 * <HreflangList title="Glass UI components" subtitle="Five hundred animated React components" structured={{true}} />
 */
import { Globe } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface HreflangListProps
...
export function HreflangList({ title = "Glass UI components", subtitle = "Five hundred animated React components", className, ...props }: HreflangListProps) {
  return (
    <section
