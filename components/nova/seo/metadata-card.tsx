/**
 * Metadata Card - Title, description and canonical summary.
 *
 ...
 * Example
 * -------
 * <MetadataCard title="Nova Vitral pricing" subtitle="One plan, no seat minimums, cancel in one click" structured={{true}} />
 */
...
export function MetadataCard({ title = "Nova Vitral pricing", subtitle = "One plan, no seat minimums, cancel in one click", className, ...props }: MetadataCardProps) {
  return (
    <section
