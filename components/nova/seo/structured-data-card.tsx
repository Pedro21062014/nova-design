/**
 * Structured Data Card - JSON-LD summary with validation state.
 *
 ...
 * Example
 * -------
 * <StructuredDataCard title="Nova Vitral pricing" subtitle="One plan, no seat minimums, cancel in one click" structured={{true}} />
 */
...
export function StructuredDataCard({ title = "Nova Vitral pricing", subtitle = "One plan, no seat minimums, cancel in one click", className, ...props }: StructuredDataCardProps) {
  return (
    <section
