/**
 * Share Preview - Preview of a shared link unfurl.
 *
 ...
 * Example
 * -------
 * <SharePreview title="Nova Vitral pricing" subtitle="One plan, no seat minimums, cancel in one click" structured={{true}} />
 */
...
export function SharePreview({ title = "Nova Vitral pricing", subtitle = "One plan, no seat minimums, cancel in one click", className, ...props }: SharePreviewProps) {
  return (
    <section
