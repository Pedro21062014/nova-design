/**
 * Og Preview - Open Graph image preview at 1200x630.
 *
 ...
 * Example
 * -------
 * <OgPreview title="Glass UI components" subtitle="Five hundred animated React components" structured={{true}} />
 */
...
export function OgPreview({ title = "Glass UI components", subtitle = "Five hundred animated React components", className, ...props }: OgPreviewProps) {
  return (
    <section
