/**
 * Canonical Chip - Canonical URL chip with copy.
 *
 ...
 * Example
 * -------
 * <CanonicalChip title="Nova Vitral pricing" subtitle="One plan, no seat minimums, cancel in one click" structured={{true}} />
 */
import { Globe } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface CanonicalChipProps
...
export function CanonicalChip({ title = "Nova Vitral pricing", subtitle = "One plan, no seat minimums, cancel in one click", className, ...props }: CanonicalChipProps) {
  return (
    <section
