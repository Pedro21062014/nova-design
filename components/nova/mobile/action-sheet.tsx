/**
 * Action Sheet - Sheet with grouped actions and cancel.
 *
 ...
 * Example
 * -------
 * <ActionSheet title="Profile" subtitle="Signed in" safeArea />
 */
...
export function ActionSheet({ title = "Profile", subtitle = "Signed in", className, ...props }: ActionSheetProps) {
  return (
    <section
