/**
 * Tab Bar - Scrollable tab bar for mobile filters.
 *
 ...
 * Example
 * -------
 * <TabBar title="Profile" subtitle="Signed in" safeArea />
 */
...
export function TabBar({ title = "Profile", subtitle = "Signed in", className, ...props }: TabBarProps) {
  return (
    <section
