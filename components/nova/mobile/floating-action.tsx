/**
 * Floating Action - Primary action pinned above the bottom nav.
 *
 ...
 * Example
 * -------
 * <FloatingAction title="Profile" subtitle="Signed in" safeArea />
 */
...
export function FloatingAction({ title = "Profile", subtitle = "Signed in", className, ...props }: FloatingActionProps) {
  return (
    <section
