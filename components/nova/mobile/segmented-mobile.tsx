/**
 * Segmented Mobile - Two-way segmented switch for small screens.
 *
 ...
 * Example
 * -------
 * <SegmentedMobile title="Orders" subtitle="Today" safeArea />
 */
import { Bell } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface SegmentedMobileProps
...
export function SegmentedMobile({ title = "Orders", subtitle = "Today", className, ...props }: SegmentedMobileProps) {
  return (
    <section
...
export default SegmentedMobile;
