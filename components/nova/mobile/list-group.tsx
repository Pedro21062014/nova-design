/**
 * List Group - Grouped list with a section header.
 *
 ...
 * Example
 * -------
 * <ListGroup title="Notifications" subtitle="3 unread" safeArea />
 */
...
export function ListGroup({ title = "Notifications", subtitle = "3 unread", className, ...props }: ListGroupProps) {
  return (
    <section
