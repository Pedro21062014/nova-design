/**
 * Safe Area Spacer - Respects home indicator spacing.
 *
 ...
 * Example
 * -------
 * <SafeAreaSpacer title="Orders" subtitle="Today" safeArea />
 */
...
export function SafeAreaSpacer({ title = "Orders", subtitle = "Today", className, ...props }: SafeAreaSpacerProps) {
  return (
    <section
