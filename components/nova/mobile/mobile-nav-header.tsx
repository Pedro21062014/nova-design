/**
 * Mobile Nav Header - Compact header with back and actions.
 *
 ...
 * Example
 * -------
 * <MobileNavHeader title="Notifications" subtitle="3 unread" safeArea />
 */
...
export function MobileNavHeader({ title = "Notifications", subtitle = "3 unread", className, ...props }: MobileNavHeaderProps) {
  return (
    <section
