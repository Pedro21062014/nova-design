/**
 * Sticky Cta - Sticky bottom CTA with safe-area padding.
 *
 ...
 * Example
 * -------
 * <StickyCta title="Orders" subtitle="Today" safeArea />
 */
...
export function StickyCta({ title = "Orders", subtitle = "Today", className, ...props }: StickyCtaProps) {
  return (
    <section
