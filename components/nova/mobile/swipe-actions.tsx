/**
 * Swipe Actions - Reveal actions behind a row.
 *
 ...
 * Example
 * -------
 * <SwipeActions title="Orders" subtitle="Today" safeArea />
 */
...
export function SwipeActions({ title = "Orders", subtitle = "Today", className, ...props }: SwipeActionsProps) {
  return (
    <section
