/**
 * Pull to Refresh - Refresh indicator driven by drag.
 *
 ...
 * Example
 * -------
 * <PullToRefresh title="Orders" subtitle="Today" safeArea />
 */
...
export function PullToRefresh({ title = "Orders", subtitle = "Today", className, ...props }: PullToRefreshProps) {
  return (
    <section
