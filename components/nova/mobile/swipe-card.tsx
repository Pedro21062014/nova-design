/**
 * Swipe Card - Card with swipe actions on touch.
 *
 ...
 * Example
 * -------
 * <SwipeCard title="Notifications" subtitle="3 unread" safeArea />
 */
...
export function SwipeCard({ title = "Notifications", subtitle = "3 unread", className, ...props }: SwipeCardProps) {
  return (
    <section
