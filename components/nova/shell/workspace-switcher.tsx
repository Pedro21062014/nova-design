/**
 * Workspace Switcher - Workspace menu with search and create.
 *
 ...
 * Example
 * -------
 * <WorkspaceSwitcher title="Billing" subtitle="Team of 8">
  {children}
</WorkspaceSwitcher>
 */
...
export function WorkspaceSwitcher({ title = "Billing", subtitle = "Team of 8", className, ...props }: WorkspaceSwitcherProps) {
  return (
    <section
