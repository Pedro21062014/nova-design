/**
 * Sessions Table - Active sessions with revoke actions.
 *
 ...
 * Example
 * -------
 * <SessionsTable title="Northwind" subtitle="Workspace">
  {children}
</SessionsTable>
 */
...
export function SessionsTable({ title = "Northwind", subtitle = "Workspace", className, ...props }: SessionsTableProps) {
  return (
    <section
