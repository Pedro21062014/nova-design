/**
 * Profile Form - Profile details with avatar upload.
 *
 ...
 * Example
 * -------
 * <ProfileForm title="Billing" subtitle="Team of 8">
  {children}
</ProfileForm>
 */
...
export function ProfileForm({ title = "Billing", subtitle = "Team of 8", className, ...props }: ProfileFormProps) {
  return (
    <section
