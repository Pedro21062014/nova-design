/**
 * Invite Dialog - Invite by email with role select.
 *
 ...
 * Example
 * -------
 * <InviteDialog title="Billing" subtitle="Team of 8">
  {children}
</InviteDialog>
 */
...
export function InviteDialog({ title = "Billing", subtitle = "Team of 8", className, ...props }: InviteDialogProps) {
  return (
    <section
