/**
 * Members Table - Members with roles and last active.
 *
 ...
 * Example
 * -------
 * <MembersTable title="Northwind" subtitle="Workspace">
  {children}
</MembersTable>
 */
...
export function MembersTable({ title = "Northwind", subtitle = "Workspace", className, ...props }: MembersTableProps) {
  return (
    <section
