/**
 * Settings Layout - Settings rail plus content column.
 *
 ...
 * Example
 * -------
 * <SettingsLayout title="Billing" subtitle="Team of 8">
  {children}
</SettingsLayout>
 */
...
export function SettingsLayout({ title = "Billing", subtitle = "Team of 8", className, ...props }: SettingsLayoutProps) {
  return (
    <section
