/**
 * Activity Drawer - Right drawer with recent workspace events.
 *
 ...
 * Example
 * -------
 * <ActivityDrawer title="Northwind" subtitle="Workspace">
  {children}
</ActivityDrawer>
 */
...
export function ActivityDrawer({ title = "Northwind", subtitle = "Workspace", className, ...props }: ActivityDrawerProps) {
  return (
    <section
