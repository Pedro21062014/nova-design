/**
 * Danger Zone - Destructive section with typed confirmation.
 *
 ...
 * Example
 * -------
 * <DangerZone title="Billing" subtitle="Team of 8">
  {children}
</DangerZone>
 */
...
export function DangerZone({ title = "Billing", subtitle = "Team of 8", className, ...props }: DangerZoneProps) {
  return (
    <section
