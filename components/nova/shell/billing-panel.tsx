/**
 * Billing Panel - Plan, seats, payment method and invoices.
 *
 ...
 * Example
 * -------
 * <BillingPanel title="Billing" subtitle="Team of 8">
  {children}
</BillingPanel>
 */
...
export function BillingPanel({ title = "Billing", subtitle = "Team of 8", className, ...props }: BillingPanelProps) {
  return (
    <section
