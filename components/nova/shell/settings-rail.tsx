/**
 * Settings Rail - Section navigation for settings.
 *
 ...
 * Example
 * -------
 * <SettingsRail title="Northwind" subtitle="Workspace">
  {children}
</SettingsRail>
 */
...
export function SettingsRail({ title = "Northwind", subtitle = "Workspace", className, ...props }: SettingsRailProps) {
  return (
    <section
