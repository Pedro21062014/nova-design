/**
 * App Layout - Sidebar, topbar and content shell.
 *
 ...
 * Example
 * -------
 * <AppLayout title="Acme Console" subtitle="Production">
  {children}
</AppLayout>
 */
...
export function AppLayout({ title = "Acme Console", subtitle = "Production", className, ...props }: AppLayoutProps) {
  return (
    <section
