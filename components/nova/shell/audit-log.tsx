/**
 * Audit Log - Authored timeline of workspace actions.
 *
 ...
 * Example
 * -------
 * <AuditLog title="Northwind" subtitle="Workspace">
  {children}
</AuditLog>
 */
...
export function AuditLog({ title = "Northwind", subtitle = "Workspace", className, ...props }: AuditLogProps) {
  return (
    <section
