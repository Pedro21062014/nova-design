/**
 * Topbar - App topbar with breadcrumb and actions.
 *
 ...
 * Example
 * -------
 * <Topbar title="Northwind" subtitle="Workspace">
  {children}
</Topbar>
 */
...
export function Topbar({ title = "Northwind", subtitle = "Workspace", className, ...props }: TopbarProps) {
  return (
    <section
