/**
 * Role Select - Role picker with permission summary.
 *
 ...
 * Example
 * -------
 * <RoleSelect title="Acme Console" subtitle="Production">
  {children}
</RoleSelect>
 */
...
export function RoleSelect({ title = "Acme Console", subtitle = "Production", className, ...props }: RoleSelectProps) {
  return (
    <section
