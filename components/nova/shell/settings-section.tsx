/**
 * Settings Section - Section with autosave and dirty tracking.
 *
 ...
 * Example
 * -------
 * <SettingsSection title="Acme Console" subtitle="Production">
  {children}
</SettingsSection>
 */
...
export function SettingsSection({ title = "Acme Console", subtitle = "Production", className, ...props }: SettingsSectionProps) {
  return (
    <section
