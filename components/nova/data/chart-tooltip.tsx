/**
 * Chart Tooltip - Glass tooltip with series dot and tabular values.
 *
 ...
 * Example
 * -------
 * <ChartTooltip title="Requests per second" subtitle="p95, 24 hours" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function ChartTooltip({ title = "Requests per second", subtitle = "p95, 24 hours", className, ...props }: ChartTooltipProps) {
  return (
    <section
