/**
 * Table Toolbar - Toolbar with search, filters and column control.
 *
 ...
 * Example
 * -------
 * <TableToolbar title="Team members" subtitle="12 seats" pageSize={{10}} />
 */
...
export function TableToolbar({ title = "Team members", subtitle = "12 seats", className, ...props }: TableToolbarProps) {
  return (
    <section
