/**
 * Progress Bar - Progress with label and percentage.
 *
 ...
 * Example
 * -------
 * <ProgressBar title="Conversion" subtitle="Visits to trials" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function ProgressBar({ title = "Conversion", subtitle = "Visits to trials", className, ...props }: ProgressBarProps) {
  return (
    <section
