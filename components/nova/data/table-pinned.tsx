/**
 * Table Pinned - First column pinned with a scroll fade mask.
 *
 ...
 * Example
 * -------
 * <TablePinned title="Incidents" subtitle="Last 90 days" pageSize={{10}} />
 */
import { Search, Settings } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface TablePinnedProps
...
export function TablePinned({ title = "Incidents", subtitle = "Last 90 days", className, ...props }: TablePinnedProps) {
  return (
    <section
