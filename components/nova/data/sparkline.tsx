/**
 * Sparkline - 24-point inline sparkline with gradient fill.
 *
 ...
 * Example
 * -------
 * <Sparkline title="Requests per second" subtitle="p95, 24 hours" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function Sparkline({ title = "Requests per second", subtitle = "p95, 24 hours", className, ...props }: SparklineProps) {
  return (
    <section
