/**
 * Area Chart - Area chart with gradient fill and reference line.
 *
 ...
 * Example
 * -------
 * <AreaChart title="Conversion" subtitle="Visits to trials" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function AreaChart({ title = "Conversion", subtitle = "Visits to trials", className, ...props }: AreaChartProps) {
  return (
    <section
