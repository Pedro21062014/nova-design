/**
 * Columns Manager - Column visibility and order manager.
 *
 ...
 * Example
 * -------
 * <ColumnsManager title="Invoices" subtitle="48 results" pageSize={{10}} />
 */
...
export function ColumnsManager({ title = "Invoices", subtitle = "48 results", className, ...props }: ColumnsManagerProps) {
  return (
    <section
