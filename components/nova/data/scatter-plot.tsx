/**
 * Scatter Plot - Scatter with trend line and hover tooltip.
 *
 ...
 * Example
 * -------
 * <ScatterPlot title="Revenue by month" subtitle="Last 6 months, USD" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function ScatterPlot({ title = "Revenue by month", subtitle = "Last 6 months, USD", className, ...props }: ScatterPlotProps) {
  return (
    <section
