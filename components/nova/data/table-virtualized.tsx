/**
 * Table Virtualized - Virtualized table for ten thousand rows.
 *
 ...
 * Example
 * -------
 * <TableVirtualized title="Incidents" subtitle="Last 90 days" pageSize={{10}} />
 */
...
export function TableVirtualized({ title = "Incidents", subtitle = "Last 90 days", className, ...props }: TableVirtualizedProps) {
  return (
    <section
