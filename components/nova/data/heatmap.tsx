/**
 * Heatmap - Day and hour activity heatmap.
 *
 ...
 * Example
 * -------
 * <Heatmap title="Revenue by month" subtitle="Last 6 months, USD" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function Heatmap({ title = "Revenue by month", subtitle = "Last 6 months, USD", className, ...props }: HeatmapProps) {
  return (
    <section
