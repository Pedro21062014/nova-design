/**
 * Chart Legend - Legend that toggles series visibility.
 *
 ...
 * Example
 * -------
 * <ChartLegend title="Revenue by month" subtitle="Last 6 months, USD" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function ChartLegend({ title = "Revenue by month", subtitle = "Last 6 months, USD", className, ...props }: ChartLegendProps) {
  return (
    <section
