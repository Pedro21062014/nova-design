/**
 * Bullet Chart - Progress against a target with a marker.
 *
 ...
 * Example
 * -------
 * <BulletChart title="Conversion" subtitle="Visits to trials" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function BulletChart({ title = "Conversion", subtitle = "Visits to trials", className, ...props }: BulletChartProps) {
  return (
    <section
