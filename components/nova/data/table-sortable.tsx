/**
 * Table Sortable - Sortable columns with three-state cycling.
 *
 ...
 * Example
 * -------
 * <TableSortable title="Team members" subtitle="12 seats" pageSize={{10}} />
 */
...
export function TableSortable({ title = "Team members", subtitle = "12 seats", className, ...props }: TableSortableProps) {
  return (
    <section
