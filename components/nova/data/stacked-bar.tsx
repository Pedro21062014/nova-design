/**
 * Stacked Bar - Stacked bars for composition over time.
 *
 ...
 * Example
 * -------
 * <StackedBar title="Requests per second" subtitle="p95, 24 hours" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function StackedBar({ title = "Requests per second", subtitle = "p95, 24 hours", className, ...props }: StackedBarProps) {
  return (
    <section
