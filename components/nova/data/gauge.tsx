/**
 * Gauge - Radial gauge for a single bounded metric.
 *
 ...
 * Example
 * -------
 * <Gauge title="Requests per second" subtitle="p95, 24 hours" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function Gauge({ title = "Requests per second", subtitle = "p95, 24 hours", className, ...props }: GaugeProps) {
  return (
    <section
