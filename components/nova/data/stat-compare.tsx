/**
 * Stat Compare - Two metrics compared with direction emphasis.
 *
 ...
 * Example
 * -------
 * <StatCompare title="Requests per second" subtitle="p95, 24 hours" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function StatCompare({ title = "Requests per second", subtitle = "p95, 24 hours", className, ...props }: StatCompareProps) {
  return (
    <section
