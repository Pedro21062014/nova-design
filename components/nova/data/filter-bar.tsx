/**
 * Filter Bar - Active filter chips with counts and clear-all.
 *
 ...
 * Example
 * -------
 * <FilterBar title="Requests per second" subtitle="p95, 24 hours" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function FilterBar({ title = "Requests per second", subtitle = "p95, 24 hours", className, ...props }: FilterBarProps) {
  return (
    <section
