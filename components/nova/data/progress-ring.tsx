/**
 * Progress Ring - Circular progress for compact spaces.
 *
 ...
 * Example
 * -------
 * <ProgressRing title="Revenue by month" subtitle="Last 6 months, USD" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function ProgressRing({ title = "Revenue by month", subtitle = "Last 6 months, USD", className, ...props }: ProgressRingProps) {
  return (
    <section
