/**
 * Saved Views - Saved views as segmented chips with pinning.
 *
 ...
 * Example
 * -------
 * <SavedViews title="Revenue by month" subtitle="Last 6 months, USD" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function SavedViews({ title = "Revenue by month", subtitle = "Last 6 months, USD", className, ...props }: SavedViewsProps) {
  return (
    <section
