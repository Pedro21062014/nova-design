/**
 * Funnel Chart - Funnel with step conversion percentages.
 *
 ...
 * Example
 * -------
 * <FunnelChart title="Requests per second" subtitle="p95, 24 hours" values={{[12, 18, 15, 24, 31, 28]}} />
 */
...
export function FunnelChart({ title = "Requests per second", subtitle = "p95, 24 hours", className, ...props }: FunnelChartProps) {
  return (
    <section
