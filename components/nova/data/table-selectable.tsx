/**
 * Table Selectable - Row selection with tri-state header checkbox.
 *
 ...
 * Example
 * -------
 * <TableSelectable title="Team members" subtitle="12 seats" pageSize={{10}} />
 */
...
export function TableSelectable({ title = "Team members", subtitle = "12 seats", className, ...props }: TableSelectableProps) {
  return (
    <section
