/**
 * Table Bulk Bar - Bulk action bar for a selection.
 *
 ...
 * Example
 * -------
 * <TableBulkBar title="Incidents" subtitle="Last 90 days" pageSize={{10}} />
 */
...
export function TableBulkBar({ title = "Incidents", subtitle = "Last 90 days", className, ...props }: TableBulkBarProps) {
  return (
    <section
