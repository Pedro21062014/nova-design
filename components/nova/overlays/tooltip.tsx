/**
 * Tooltip - Delayed tooltip limited to a label.
 *
 ...
 * Example
 * -------
 * <Tooltip title="Choose a plan" subtitle="Change at any time" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function Tooltip({ title = "Choose a plan", subtitle = "Change at any time", className, ...props }: TooltipProps) {
  return (
    <section
