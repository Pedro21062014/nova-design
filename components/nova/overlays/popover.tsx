/**
 * Popover - Anchored glass popover with collision handling.
 *
 ...
 * Example
 * -------
 * <Popover title="Delete workspace" subtitle="This cannot be undone" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function Popover({ title = "Delete workspace", subtitle = "This cannot be undone", className, ...props }: PopoverProps) {
  return (
    <section
