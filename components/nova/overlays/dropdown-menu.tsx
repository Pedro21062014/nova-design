/**
 * Dropdown Menu - Menu with shortcuts, groups and danger row.
 *
 ...
 * Example
 * -------
 * <DropdownMenu title="Invite a teammate" subtitle="They receive an email in a moment" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function DropdownMenu({ title = "Invite a teammate", subtitle = "They receive an email in a moment", className, ...props }: DropdownMenuProps) {
  return (
    <section
