/**
 * Modal - Centered dialog with scrim, focus trap and exit.
 *
 ...
 * Example
 * -------
 * <Modal title="Invite a teammate" subtitle="They receive an email in a moment" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function Modal({ title = "Invite a teammate", subtitle = "They receive an email in a moment", className, ...props }: ModalProps) {
  return (
    <section
