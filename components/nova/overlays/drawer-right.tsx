/**
 * Drawer Right - Right drawer for forms and details.
 *
 ...
 * Example
 * -------
 * <DrawerRight title="Choose a plan" subtitle="Change at any time" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function DrawerRight({ title = "Choose a plan", subtitle = "Change at any time", className, ...props }: DrawerRightProps) {
  return (
    <section
