/**
 * Toast Item - Single toast with icon tone and action.
 *
 ...
 * Example
 * -------
 * <ToastItem title="Choose a plan" subtitle="Change at any time" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function ToastItem({ title = "Choose a plan", subtitle = "Change at any time", className, ...props }: ToastItemProps) {
  return (
    <section
