/**
 * Onboarding Tour - Coach marks with a spotlight cutout.
 *
 ...
 * Example
 * -------
 * <OnboardingTour title="Delete workspace" subtitle="This cannot be undone" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function OnboardingTour({ title = "Delete workspace", subtitle = "This cannot be undone", className, ...props }: OnboardingTourProps) {
  return (
    <section
