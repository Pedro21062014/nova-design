/**
 * Cookie Bar - Non-blocking consent with two real choices.
 *
 ...
 * Example
 * -------
 * <CookieBar title="Invite a teammate" subtitle="They receive an email in a moment" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function CookieBar({ title = "Invite a teammate", subtitle = "They receive an email in a moment", className, ...props }: CookieBarProps) {
  return (
    <section
