/**
 * Preview Modal - Preview of a file or artifact before commit.
 *
 ...
 * Example
 * -------
 * <PreviewModal title="Invite a teammate" subtitle="They receive an email in a moment" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function PreviewModal({ title = "Invite a teammate", subtitle = "They receive an email in a moment", className, ...props }: PreviewModalProps) {
  return (
    <section
