/**
 * Toaster - Toast host with stacking and promise support.
 *
...
export function Toaster({ title = "Delete workspace", subtitle = "This cannot be undone", className, ...props }: ToasterProps) {
  return (
    <section
