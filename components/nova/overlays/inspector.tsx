/**
 * Inspector - Property inspector for a selected object.
 *
 ...
 * Example
 * -------
 * <Inspector title="Choose a plan" subtitle="Change at any time" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function Inspector({ title = "Choose a plan", subtitle = "Change at any time", className, ...props }: InspectorProps) {
  return (
    <section
