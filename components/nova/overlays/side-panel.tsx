/**
 * Side Panel - Persistent side panel for inspection.
 *
 ...
 * Example
 * -------
 * <SidePanel title="Delete workspace" subtitle="This cannot be undone" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function SidePanel({ title = "Delete workspace", subtitle = "This cannot be undone", className, ...props }: SidePanelProps) {
  return (
    <section
