/**
 * Lightbox - Media viewer with keyboard, swipe and preloading.
 *
 ...
 * Example
 * -------
 * <Lightbox title="Invite a teammate" subtitle="They receive an email in a moment" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function Lightbox({ title = "Invite a teammate", subtitle = "They receive an email in a moment", className, ...props }: LightboxProps) {
  return (
    <section
