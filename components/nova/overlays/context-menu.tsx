/**
 * Context Menu - Right-click menu sharing the menu primitive.
 *
 ...
 * Example
 * -------
 * <ContextMenu title="Delete workspace" subtitle="This cannot be undone" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function ContextMenu({ title = "Delete workspace", subtitle = "This cannot be undone", className, ...props }: ContextMenuProps) {
  return (
    <section
