/**
 * Command Sheet - Mobile command surface.
 *
 ...
 * Example
 * -------
 * <CommandSheet title="Choose a plan" subtitle="Change at any time" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function CommandSheet({ title = "Choose a plan", subtitle = "Change at any time", className, ...props }: CommandSheetProps) {
  return (
    <section
