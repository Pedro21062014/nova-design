/**
 * Announce Bar - Top announcement with dismiss memory.
 *
 ...
 * Example
 * -------
 * <AnnounceBar title="Choose a plan" subtitle="Change at any time" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function AnnounceBar({ title = "Choose a plan", subtitle = "Change at any time", className, ...props }: AnnounceBarProps) {
  return (
    <section
