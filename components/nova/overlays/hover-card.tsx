/**
 * Hover Card - Rich preview on hover with delay.
 *
 ...
 * Example
 * -------
 * <HoverCard title="Choose a plan" subtitle="Change at any time" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function HoverCard({ title = "Choose a plan", subtitle = "Change at any time", className, ...props }: HoverCardProps) {
  return (
    <section
