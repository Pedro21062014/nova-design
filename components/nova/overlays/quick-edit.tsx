/**
 * Quick Edit - Inline edit surface that replaces content.
 *
 ...
 * Example
 * -------
 * <QuickEdit title="Invite a teammate" subtitle="They receive an email in a moment" open={{open}} onOpenChange={{setOpen}} />
 */
...
export function QuickEdit({ title = "Invite a teammate", subtitle = "They receive an email in a moment", className, ...props }: QuickEditProps) {
  return (
    <section
