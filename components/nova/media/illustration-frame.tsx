/**
 * Illustration Frame - Glass plate framing an illustration.
 *
 ...
 * Example
 * -------
 * <IllustrationFrame title="Onboarding clip" subtitle="0:38, silent" aspect="16/9" />
 */
...
export function IllustrationFrame({ title = "Onboarding clip", subtitle = "0:38, silent", className, ...props }: IllustrationFrameProps) {
  return (
    <section
