/**
 * Video Player - Glass chrome, poster veil and captions.
 *
 ...
 * Example
 * -------
 * <VideoPlayer title="Product tour" subtitle="1:42, captions available" aspect="16/9" />
 */
...
export function VideoPlayer({ title = "Product tour", subtitle = "1:42, captions available", className, ...props }: VideoPlayerProps) {
  return (
    <section
