/**
 * Image Card - Image with caption, hairline frame and lightbox.
 *
 ...
 * Example
 * -------
 * <ImageCard title="Product tour" subtitle="1:42, captions available" aspect="16/9" />
 */
...
export function ImageCard({ title = "Product tour", subtitle = "1:42, captions available", className, ...props }: ImageCardProps) {
  return (
    <section
