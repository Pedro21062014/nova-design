/**
 * Lightbox Thumbs - Thumbnail strip synced with a viewer.
 *
...
export function LightboxThumbs({ title = "Onboarding clip", subtitle = "0:38, silent", className, ...props }: LightboxThumbsProps) {
  return (
    <section
