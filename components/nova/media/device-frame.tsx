/**
 * Device Frame - Laptop or phone frame for screenshots.
 *
 ...
 * Example
 * -------
 * <DeviceFrame title="Product tour" subtitle="1:42, captions available" aspect="16/9" />
 */
...
export function DeviceFrame({ title = "Product tour", subtitle = "1:42, captions available", className, ...props }: DeviceFrameProps) {
  return (
    <section
