/**
 * Avatar Group - Overlapping avatars with an overflow chip.
 *
 ...
 * Example
 * -------
 * <AvatarGroup title="Product tour" subtitle="1:42, captions available" aspect="16/9" />
 */
...
export function AvatarGroup({ title = "Product tour", subtitle = "1:42, captions available", className, ...props }: AvatarGroupProps) {
  return (
    <section
