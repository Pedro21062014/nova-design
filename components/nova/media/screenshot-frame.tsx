/**
 * Screenshot Frame - Browser chrome frame for product shots.
 *
 ...
 * Example
 * -------
 * <ScreenshotFrame title="Q3 all-hands" subtitle="Recording, 48 min" aspect="16/9" />
 */
...
export function ScreenshotFrame({ title = "Q3 all-hands", subtitle = "Recording, 48 min", className, ...props }: ScreenshotFrameProps) {
  return (
    <section
