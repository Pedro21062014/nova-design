/**
 * Favicon Chip - Domain chip with favicon and title.
 *
 ...
 * Example
 * -------
 * <FaviconChip title="Product tour" subtitle="1:42, captions available" aspect="16/9" />
 */
...
export function FaviconChip({ title = "Product tour", subtitle = "1:42, captions available", className, ...props }: FaviconChipProps) {
  return (
    <section
