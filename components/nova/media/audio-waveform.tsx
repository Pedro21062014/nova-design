/**
 * Audio Waveform - Waveform player with speed control.
 *
 ...
 * Example
 * -------
 * <AudioWaveform title="Q3 all-hands" subtitle="Recording, 48 min" aspect="16/9" />
 */
...
export function AudioWaveform({ title = "Q3 all-hands", subtitle = "Recording, 48 min", className, ...props }: AudioWaveformProps) {
  return (
    <section
