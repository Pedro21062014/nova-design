/**
 * Avatar - Avatar with initials fallback on a calm gradient.
 *
 ...
 * Example
 * -------
 * <Avatar title="Onboarding clip" subtitle="0:38, silent" aspect="16/9" />
 */
...
export function Avatar({ title = "Onboarding clip", subtitle = "0:38, silent", className, ...props }: AvatarProps) {
  return (
    <section
