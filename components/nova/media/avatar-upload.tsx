/**
 * Avatar Upload - Upload with crop framing and remove.
 *
 ...
 * Example
 * -------
 * <AvatarUpload title="Q3 all-hands" subtitle="Recording, 48 min" aspect="16/9" />
 */
...
export function AvatarUpload({ title = "Q3 all-hands", subtitle = "Recording, 48 min", className, ...props }: AvatarUploadProps) {
  return (
    <section
