/**
 * Page Transition - 180ms fade and rise between marketing routes.
 *
...
export function PageTransition({ title = "Entrance", subtitle = "Delay 120ms", className, ...props }: PageTransitionProps) {
  return (
    <section
