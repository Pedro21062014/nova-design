/**
 * List Reorder - Animated reordering for lists and queues.
 *
...
export interface ListReorderProps
...
export function ListReorder({ title = "Entrance", subtitle = "Once, on first view", className, ...props }: ListReorderProps) {
  return (
    <section
