/**
 * Parallax Visual - Scroll-linked vertical drift with spring damping.
 *
...
export function ParallaxVisual({ title = "Entrance", subtitle = "Delay 120ms", className, ...props }: ParallaxVisualProps) {
  return (
    <section
