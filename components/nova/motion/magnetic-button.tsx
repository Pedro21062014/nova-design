/**
 * Magnetic Button - Button that leans toward the pointer within limits.
 *
...
export function MagneticButton({ title = "Entrance", subtitle = "Once, on first view", className, ...props }: MagneticButtonProps) {
  return (
    <section
