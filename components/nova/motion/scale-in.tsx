/**
 * Scale in - Scale entrance reserved for modals and featured cards.
 *
...
export function ScaleIn({ title = "Entrance", subtitle = "Delay 120ms", className, ...props }: ScaleInProps) {
  return (
    <section
