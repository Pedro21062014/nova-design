/**
 * Parallax Layer - Single depth layer for multi-layer parallax scenes.
 *
...
export function ParallaxLayer({ title = "Entrance", subtitle = "Once, on first view", className, ...props }: ParallaxLayerProps) {
  return (
    <section
