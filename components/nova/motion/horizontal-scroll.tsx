/**
 * Horizontal Scroll - Vertical scroll that drives a horizontal gallery.
 *
...
export function HorizontalScroll({ title = "Entrance", subtitle = "Once, on first view", className, ...props }: HorizontalScrollProps) {
  return (
    <section
