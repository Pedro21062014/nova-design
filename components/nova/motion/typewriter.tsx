/**
 * Typewriter - Typed text with a caret, pauses on long stalls.
 *
...
export function Typewriter({ title = "Entrance", subtitle = "Once, on first view", className, ...props }: TypewriterProps) {
  return (
    <section
