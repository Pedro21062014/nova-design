/**
 * Slide in X - Horizontal entrance for drawers and side panels.
 *
...
export interface SlideInXProps
...
export function SlideInX({ title = "Entrance", subtitle = "Delay 120ms", className, ...props }: SlideInXProps) {
  return (
    <section
