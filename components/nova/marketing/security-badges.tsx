/**
 * Security Badges - Compliance badge grid with a trust link.
 *
...
export function SecurityBadges({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: SecurityBadgesProps) {
  return (
    <section
