/**
 * Testimonials Grid - Three quote cards with real attribution.
 *
...
export function TestimonialsGrid({ title = "From idea to interface in an afternoon", subtitle = "Structure first, then light", className, ...props }: TestimonialsGridProps) {
  return (
    <section
