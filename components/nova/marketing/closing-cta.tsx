/**
 * Closing Cta - Final conversion block with micro-copy.
 *
...
export function ClosingCta({ title = "From idea to interface in an afternoon", subtitle = "Structure first, then light", className, ...props }: ClosingCtaProps) {
  return (
    <section
