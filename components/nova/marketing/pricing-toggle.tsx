/**
 * Pricing Toggle - Monthly and annual segmented control.
 *
...
export function PricingToggle({ title = "From idea to interface in an afternoon", subtitle = "Structure first, then light", className, ...props }: PricingToggleProps) {
  return (
    <section
