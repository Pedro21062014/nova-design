/**
 * Logo Cloud - Monochrome logo row at reduced opacity.
 *
...
export function LogoCloud({ title = "From idea to interface in an afternoon", subtitle = "Structure first, then light", className, ...props }: LogoCloudProps) {
  return (
    <section
