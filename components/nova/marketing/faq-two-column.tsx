/**
 * Faq Two Column - Questions left, answers right.
 *
...
export function FaqTwoColumn({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: FaqTwoColumnProps) {
  return (
    <section
