/**
 * Feature List Icons - Compact checklist of capabilities.
 *
...
export interface FeatureListIconsProps
...
export function FeatureListIcons({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: FeatureListIconsProps) {
  return (
    <section
...
export default FeatureListIcons;
