/**
 * Features Bento - Bento grid with one hero cell.
 *
...
export function FeaturesBento({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: FeaturesBentoProps) {
  return (
    <section
