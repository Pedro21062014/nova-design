/**
 * Features Grid - Three-column feature grid with icon tiles.
 *
...
export function FeaturesGrid({ title = "From idea to interface in an afternoon", subtitle = "Structure first, then light", className, ...props }: FeaturesGridProps) {
  return (
    <section
