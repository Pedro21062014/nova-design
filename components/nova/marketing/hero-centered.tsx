/**
 * Hero Centered - Centered hero with gradient headline and visual anchor.
 *
...
export function HeroCentered({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: HeroCenteredProps) {
  return (
    <section
