/**
 * Cta Split - CTA with a metric on the trailing side.
 *
...
export function CtaSplit({ title = "From idea to interface in an afternoon", subtitle = "Structure first, then light", className, ...props }: CtaSplitProps) {
  return (
    <section
