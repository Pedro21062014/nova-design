/**
 * Pricing Calculator - Live estimate from sliders and inputs.
 *
...
export function PricingCalculator({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: PricingCalculatorProps) {
  return (
    <section
