/**
 * Pricing Three - Three plans with a billing toggle.
 *
...
export function PricingThree({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: PricingThreeProps) {
  return (
    <section
