/**
 * Metrics Row - Compact metric strip for the mid page.
 *
...
export function MetricsRow({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: MetricsRowProps) {
  return (
    <section
