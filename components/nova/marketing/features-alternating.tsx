/**
 * Features Alternating - Alternating rows of copy and visual.
 *
...
export function FeaturesAlternating({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: FeaturesAlternatingProps) {
  return (
    <section
    ...
    >
      <header className="flex items-baseline justify-between gap-4">
        ...
        <span className="shrink-0 font-[var(--font-mono)] text-[11px] text-[var(--fg-subtle)]">
          marketing/features-alternating
        </span>
      </header>
