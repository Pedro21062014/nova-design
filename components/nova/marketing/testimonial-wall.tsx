/**
 * Testimonial Wall - Two columns with a 0.04 parallax offset.
 *
...
export function TestimonialWall({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: TestimonialWallProps) {
  return (
    <section
