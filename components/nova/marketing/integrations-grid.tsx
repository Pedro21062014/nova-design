/**
 * Integrations Grid - Integration tiles with hover names.
 *
...
export function IntegrationsGrid({ title = "From idea to interface in an afternoon", subtitle = "Structure first, then light", className, ...props }: IntegrationsGridProps) {
  return (
    <section
