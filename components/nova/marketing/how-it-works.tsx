/**
 * How It Works - Three-step explainer with a tabbed preview.
 *
...
export function HowItWorks({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: HowItWorksProps) {
  return (
    <section
