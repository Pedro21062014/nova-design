/**
 * Trust Row - Avatars, rating and volume claim.
 *
...
export function TrustRow({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: TrustRowProps) {
  return (
    <section
