/**
 * Careers List - Open roles with location and team chips.
 *
...
export function CareersList({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: CareersListProps) {
  return (
    <section
