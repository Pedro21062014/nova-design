/**
 * Hero Minimal - Type-first hero without a visual.
 *
...
export function HeroMinimal({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: HeroMinimalProps) {
  return (
    <section
