/**
 * Marquee Logos - Infinite logo marquee with mask fade.
 *
...
export function MarqueeLogos({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: MarqueeLogosProps) {
  return (
    <section
