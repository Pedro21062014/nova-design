/**
 * Customers Grid - Customer logos with case study links.
 *
...
export function CustomersGrid({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: CustomersGridProps) {
  return (
    <section
