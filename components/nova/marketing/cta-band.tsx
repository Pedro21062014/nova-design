/**
 * Cta Band - Full-width glass band with an internal glow.
 *
...
export function CtaBand({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: CtaBandProps) {
  return (
    <section
