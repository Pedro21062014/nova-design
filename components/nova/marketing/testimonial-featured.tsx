/**
 * Testimonial Featured - Portrait plus quote at half width each.
 *
...
export function TestimonialFeatured({ title = "Every screen already considered", subtitle = "Nova Vitral keeps one visual grammar across the whole product", className, ...props }: TestimonialFeaturedProps) {
  return (
    <section
