/**
 * Newsletter Inline - Inline capture with success replacement.
 *
...
export function NewsletterInline({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: NewsletterInlineProps) {
  return (
    <section
