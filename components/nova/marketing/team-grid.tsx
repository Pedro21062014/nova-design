/**
 * Team Grid - Team members with roles and socials.
 *
...
export function TeamGrid({ title = "From idea to interface in an afternoon", subtitle = "Structure first, then light", className, ...props }: TeamGridProps) {
  return (
    <section
