/**
 * Product Tour - Tabbed interface preview with fixed aspect.
 *
...
export function ProductTour({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: ProductTourProps) {
  return (
    <section
