/**
 * Comparison Table - Honest feature comparison with an accent column.
 *
...
export function ComparisonTable({ title = "Ship the boring parts faster", subtitle = "Themes, tables, settings and email, already designed", className, ...props }: ComparisonTableProps) {
  return (
    <section
