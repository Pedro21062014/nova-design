/**
 * Billing Toggle - Monthly and annual switch with savings note.
 *
 ...
 * Example
 * -------
 * <BillingToggle title="Pro plan" subtitle="For teams up to 50" price={{49}} />
 */
...
export function BillingToggle({ title = "Pro plan", subtitle = "For teams up to 50", className, ...props }: BillingToggleProps) {
  return (
    <section
