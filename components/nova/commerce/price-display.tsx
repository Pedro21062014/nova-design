/**
 * Price Display - Price with period and billing note.
 *
 ...
 * Example
 * -------
 * <PriceDisplay title="Starter plan" subtitle="Solo builders" price={{49}} />
 */
...
export function PriceDisplay({ title = "Starter plan", subtitle = "Solo builders", className, ...props }: PriceDisplayProps) {
  return (
    <section
