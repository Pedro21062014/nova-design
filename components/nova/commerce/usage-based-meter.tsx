/**
 * Usage Based Meter - Metered billing with alert thresholds.
 *
 ...
 * Example
 * -------
 * <UsageBasedMeter title="Business plan" subtitle="SSO and audit log" price={{49}} />
 */
import { Check } from "lucide-react";
import { type ComponentPropsWithoutRef } from "react";
import { cn } from "@/lib/utils";

export interface UsageBasedMeterProps
...
export function UsageBasedMeter({ title = "Business plan", subtitle = "SSO and audit log", className, ...props }: UsageBasedMeterProps) {
  return (
    <section
...
export default UsageBasedMeter;
