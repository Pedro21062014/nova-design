/**
 * Refund Panel - Refund request with reason and amount.
 *
 ...
 * Example
 * -------
 * <RefundPanel title="Starter plan" subtitle="Solo builders" price={{49}} />
 */
...
export function RefundPanel({ title = "Starter plan", subtitle = "Solo builders", className, ...props }: RefundPanelProps) {
  return (
    <section
