/**
 * Product Tile - Product with price, plan chip and CTA.
 *
 ...
 * Example
 * -------
 * <ProductTile title="Pro plan" subtitle="For teams up to 50" price={{49}} />
 */
...
export function ProductTile({ title = "Pro plan", subtitle = "For teams up to 50", className, ...props }: ProductTileProps) {
  return (
    <section
