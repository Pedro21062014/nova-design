/**
 * Trial Banner - Trial countdown with an upgrade action.
 *
 ...
 * Example
 * -------
 * <TrialBanner title="Starter plan" subtitle="Solo builders" price={{49}} />
 */
...
export function TrialBanner({ title = "Starter plan", subtitle = "Solo builders", className, ...props }: TrialBannerProps) {
  return (
    <section
