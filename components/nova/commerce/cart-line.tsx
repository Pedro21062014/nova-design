/**
 * Cart Line - Cart row with quantity and remove.
 *
 ...
 * Example
 * -------
 * <CartLine title="Business plan" subtitle="SSO and audit log" price={{49}} />
 */
...
export function CartLine({ title = "Business plan", subtitle = "SSO and audit log", className, ...props }: CartLineProps) {
  return (
    <section
