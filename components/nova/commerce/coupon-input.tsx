/**
 * Coupon Input - Coupon field with inline validation.
 *
 ...
 * Example
 * -------
 * <CouponInput title="Pro plan" subtitle="For teams up to 50" price={{49}} />
 */
...
export function CouponInput({ title = "Pro plan", subtitle = "For teams up to 50", className, ...props }: CouponInputProps) {
  return (
    <section
