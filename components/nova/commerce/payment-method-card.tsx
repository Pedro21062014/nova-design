/**
 * Payment Method Card - Saved card with expiry and default marker.
 *
 ...
 * Example
 * -------
 * <PaymentMethodCard title="Pro plan" subtitle="For teams up to 50" price={{49}} />
 */
...
export function PaymentMethodCard({ title = "Pro plan", subtitle = "For teams up to 50", className, ...props }: PaymentMethodCardProps) {
  return (
    <section
