/**
 * Receipt Card - Payment receipt with a download action.
 *
 ...
 * Example
 * -------
 * <ReceiptCard title="Business plan" subtitle="SSO and audit log" price={{49}} />
 */
...
export function ReceiptCard({ title = "Business plan", subtitle = "SSO and audit log", className, ...props }: ReceiptCardProps) {
  return (
    <section
