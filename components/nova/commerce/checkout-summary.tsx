/**
 * Checkout Summary - Totals with tax lines and discount.
 *
 ...
 * Example
 * -------
 * <CheckoutSummary title="Starter plan" subtitle="Solo builders" price={{49}} />
 */
...
export function CheckoutSummary({ title = "Starter plan", subtitle = "Solo builders", className, ...props }: CheckoutSummaryProps) {
  return (
    <section
