/**
 * Discount Chip - Savings chip with original price.
 *
 ...
 * Example
 * -------
 * <DiscountChip title="Business plan" subtitle="SSO and audit log" price={{49}} />
 */
...
export function DiscountChip({ title = "Business plan", subtitle = "SSO and audit log", className, ...props }: DiscountChipProps) {
  return (
    <section
