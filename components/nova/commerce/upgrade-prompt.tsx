/**
 * Upgrade Prompt - Contextual upgrade at the limit.
 *
 ...
 * Example
 * -------
 * <UpgradePrompt title="Pro plan" subtitle="For teams up to 50" price={{49}} />
 */
...
export function UpgradePrompt({ title = "Pro plan", subtitle = "For teams up to 50", className, ...props }: UpgradePromptProps) {
  return (
    <section
