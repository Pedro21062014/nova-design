/**
 * Invoice Row - Invoice line with status and amount.
 *
 ...
 * Example
 * -------
 * <InvoiceRow title="Business plan" subtitle="SSO and audit log" price={{49}} />
 */
...
export function InvoiceRow({ title = "Business plan", subtitle = "SSO and audit log", className, ...props }: InvoiceRowProps) {
  return (
    <section
