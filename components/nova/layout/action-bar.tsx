/**
 * Action Bar - Contextual actions for a selection.
 *
 ...
 * Example
 * -------
 * <ActionBar title="Changelog" subtitle="Released weekly">
  {children}
</ActionBar>
 */
...
export function ActionBar({ title = "Changelog", subtitle = "Released weekly", className, ...props }: ActionBarProps) {
  return (
    <section
