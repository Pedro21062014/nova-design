/**
 * Gallery Mosaic - Mosaic gallery with a full-bleed row.
 *
 ...
 * Example
 * -------
 * <GalleryMosaic title="Settings" subtitle="Workspace preferences">
  {children}
</GalleryMosaic>
 */
...
export function GalleryMosaic({ title = "Settings", subtitle = "Workspace preferences", className, ...props }: GalleryMosaicProps) {
  return (
    <section
