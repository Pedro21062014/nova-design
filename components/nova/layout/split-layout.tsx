/**
 * Split Layout - Two-column split with a sticky side.
 *
 ...
 * Example
 * -------
 * <SplitLayout title="Changelog" subtitle="Released weekly">
  {children}
</SplitLayout>
 */
...
export function SplitLayout({ title = "Changelog", subtitle = "Released weekly", className, ...props }: SplitLayoutProps) {
  return (
    <section
