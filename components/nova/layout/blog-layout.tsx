/**
 * Blog Layout - Index with featured post and grid.
 *
 ...
 * Example
 * -------
 * <BlogLayout title="Settings" subtitle="Workspace preferences">
  {children}
</BlogLayout>
 */
...
export function BlogLayout({ title = "Settings", subtitle = "Workspace preferences", className, ...props }: BlogLayoutProps) {
  return (
    <section
