/**
 * Empty Layout - Centered single-column layout for states.
 *
 ...
 * Example
 * -------
 * <EmptyLayout title="Changelog" subtitle="Released weekly">
  {children}
</EmptyLayout>
 */
...
export function EmptyLayout({ title = "Changelog", subtitle = "Released weekly", className, ...props }: EmptyLayoutProps) {
  return (
    <section
