/**
 * Bento Grid - Mixed spans with one hero cell.
 *
 ...
 * Example
 * -------
 * <BentoGrid title="Documentation" subtitle="Guides, references and recipes">
  {children}
</BentoGrid>
 */
...
export function BentoGrid({ title = "Documentation", subtitle = "Guides, references and recipes", className, ...props }: BentoGridProps) {
  return (
    <section
