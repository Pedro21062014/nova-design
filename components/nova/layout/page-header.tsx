/**
 * Page Header - Page title with breadcrumb and actions.
 *
 ...
 * Example
 * -------
 * <PageHeader title="Documentation" subtitle="Guides, references and recipes">
  {children}
</PageHeader>
 */
...
export function PageHeader({ title = "Documentation", subtitle = "Guides, references and recipes", className, ...props }: PageHeaderProps) {
  return (
    <section
