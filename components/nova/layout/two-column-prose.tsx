/**
 * Two Column Prose - Measure-capped article layout.
 *
 ...
 * Example
 * -------
 * <TwoColumnProse title="Documentation" subtitle="Guides, references and recipes">
  {children}
</TwoColumnProse>
 */
...
export interface TwoColumnProseProps
...
export function TwoColumnProse({ title = "Documentation", subtitle = "Guides, references and recipes", className, ...props }: TwoColumnProseProps) {
  return (
    <section
