/**
 * Full Bleed - Edge-to-edge band inside a contained page.
 *
 ...
 * Example
 * -------
 * <FullBleed title="Changelog" subtitle="Released weekly">
  {children}
</FullBleed>
 */
...
export function FullBleed({ title = "Changelog", subtitle = "Released weekly", className, ...props }: FullBleedProps) {
  return (
    <section
