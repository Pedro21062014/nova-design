/**
 * Sticky Aside - Sticky sidebar that releases before the next section.
 *
 ...
 * Example
 * -------
 * <StickyAside title="Settings" subtitle="Workspace preferences">
  {children}
</StickyAside>
 */
...
export function StickyAside({ title = "Settings", subtitle = "Workspace preferences", className, ...props }: StickyAsideProps) {
  return (
    <section
