/**
 * Hero Content - Content-first hero for inner pages.
 *
 ...
 * Example
 * -------
 * <HeroContent title="Documentation" subtitle="Guides, references and recipes">
  {children}
</HeroContent>
 */
...
export function HeroContent({ title = "Documentation", subtitle = "Guides, references and recipes", className, ...props }: HeroContentProps) {
  return (
    <section
