/**
 * Docs Layout - Tree, content and on-this-page rail.
 *
 ...
 * Example
 * -------
 * <DocsLayout title="Changelog" subtitle="Released weekly">
  {children}
</DocsLayout>
 */
...
export function DocsLayout({ title = "Changelog", subtitle = "Released weekly", className, ...props }: DocsLayoutProps) {
  return (
    <section
