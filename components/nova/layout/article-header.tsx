/**
 * Article Header - Article header with author and date.
 *
 ...
 * Example
 * -------
 * <ArticleHeader title="Settings" subtitle="Workspace preferences">
  {children}
</ArticleHeader>
 */
...
export function ArticleHeader({ title = "Settings", subtitle = "Workspace preferences", className, ...props }: ArticleHeaderProps) {
  return (
    <section
