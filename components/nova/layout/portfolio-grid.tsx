/**
 * Portfolio Grid - Project grid with mixed media.
 *
 ...
 * Example
 * -------
 * <PortfolioGrid title="Documentation" subtitle="Guides, references and recipes">
  {children}
</PortfolioGrid>
 */
...
export function PortfolioGrid({ title = "Documentation", subtitle = "Guides, references and recipes", className, ...props }: PortfolioGridProps) {
  return (
    <section
