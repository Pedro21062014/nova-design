/**
 * Sticky Toolbar - Toolbar that sticks under the navbar.
 *
 ...
 * Example
 * -------
 * <StickyToolbar title="Documentation" subtitle="Guides, references and recipes">
  {children}
</StickyToolbar>
 */
...
export function StickyToolbar({ title = "Documentation", subtitle = "Guides, references and recipes", className, ...props }: StickyToolbarProps) {
  return (
    <section
