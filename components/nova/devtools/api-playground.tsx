/**
 * Api Playground - Request builder with response viewer.
 *
 ...
 * Example
 * -------
 * <ApiPlayground title="Timeline" subtitle="Session 4b21" />
 */
...
export function ApiPlayground({ title = "Timeline", subtitle = "Session 4b21", className, ...props }: ApiPlaygroundProps) {
  return (
    <section
