/**
 * Json Inspector - Property inspector for a payload.
 *
 ...
 * Example
 * -------
 * <JsonInspector title="Timeline" subtitle="Session 4b21" />
 */
...
export function JsonInspector({ title = "Timeline", subtitle = "Session 4b21", className, ...props }: JsonInspectorProps) {
  return (
    <section
