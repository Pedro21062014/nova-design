/**
 * Command Bar - Inline command input with suggestions.
 *
 ...
 * Example
 * -------
 * <CommandBar title="Network" subtitle="Production build" />
 */
...
export function CommandBar({ title = "Network", subtitle = "Production build", className, ...props }: CommandBarProps) {
  return (
    <section
