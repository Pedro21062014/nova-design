/**
 * Schema Viewer - Table schema with column types.
 *
 ...
 * Example
 * -------
 * <SchemaViewer title="Console" subtitle="2 warnings" />
 */
...
export function SchemaViewer({ title = "Console", subtitle = "2 warnings", className, ...props }: SchemaViewerProps) {
  return (
    <section
