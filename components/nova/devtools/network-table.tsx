/**
 * Network Table - Network calls with status and size.
 *
 ...
 * Example
 * -------
 * <NetworkTable title="Console" subtitle="2 warnings" />
 */
...
export function NetworkTable({ title = "Console", subtitle = "2 warnings", className, ...props }: NetworkTableProps) {
  return (
    <section
