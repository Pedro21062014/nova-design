/**
 * Webhook Tester - Endpoint tester with event replay.
 *
 ...
 * Example
 * -------
 * <WebhookTester title="Network" subtitle="Production build" />
 */
...
export function WebhookTester({ title = "Network", subtitle = "Production build", className, ...props }: WebhookTesterProps) {
  return (
    <section
