/**
 * Env Switcher - Environment switch with a danger tone.
 *
...
export function EnvSwitcher({ title = "Network", subtitle = "Production build", className, ...props }: EnvSwitcherProps) {
  return (
    <section
