/**
 * Error Report - Crash report with stack and context.
 *
 ...
 * Example
 * -------
 * <ErrorReport title="Network" subtitle="Production build" />
 */
...
export function ErrorReport({ title = "Network", subtitle = "Production build", className, ...props }: ErrorReportProps) {
  return (
    <section
