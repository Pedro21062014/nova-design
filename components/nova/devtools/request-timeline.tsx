/**
 * Request Timeline - Waterfall of requests and durations.
 *
 ...
 * Example
 * -------
 * <RequestTimeline title="Network" subtitle="Production build" />
 */
...
export function RequestTimeline({ title = "Network", subtitle = "Production build", className, ...props }: RequestTimelineProps) {
  return (
    <section
